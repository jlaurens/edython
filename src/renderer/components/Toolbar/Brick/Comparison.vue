<template>
  <b-btn-group>
    ...
    <b-input
      ...
      :placeholder="$$t(isNum ? 'brick.placeholder.number' : 'brick.placeholder.element')"></b-input>
    <b-dd
      id="brick-compare-operator"
    ...
    <b-input
      ...
      :class="$$class(rhs)"
      :style='{fontFamily: $$.eYo.Font.familyMono}'
      :placeholder="$$t(isNum ? 'brick.placeholder.number' : 'brick.placeholder.container')"></b-input>
  </b-btn-group>
</template>
