<template>
  <b-btn-toolbar id="block-except" key-nav  aria-label="Block decorator" justify>
    <b-btn-group>
        <span class="btn-outline-secondary eyo-code eyo-code-reserved" :style="{fontFamily: $$.eYo.Font.familyMono}">except</span>
      ...
      <b-form-input v-if="can_expression" v-model="expression" type="text" class="btn-outline-secondary eyo-form-input-text eyo-form-input-text-any-expression eyo-width-10" :title="$t('message.except_expression')" v-tippy  :style="{fontFamily: $$.eYo.Font.familyMono}"></b-form-input>
      <span v-if="can_alias" class="btn-outline-secondary eyo-code-reserved" :style="{fontFamily: $$.eYo.Font.familyMono}"" >as</span>
      <b-form-input v-if="can_alias" v-model="alias" type="text" class="btn-outline-secondary eyo-form-input-text eyo-form-input-text-any-expression eyo-width-10" :style="{fontFamily: $$.eYo.Font.familyMono}"" :title="$t('message.except_alias')" v-tippy ></b-form-input>
