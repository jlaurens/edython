        ...
        demos: [
          {
            ...
            xml: '<xml xmlns="http://www.w3.org/1999/xhtml" xmlns:eyo="urn:edython:1.0"><eyo:workspace><eyo:content><eyo:start_stmt x="300" y="120"><eyo:print eyo:flow="next"><eyo:list eyo:slot="arguments"><eyo:literal eyo:slot="O">\'Bonjour le monde!\'</eyo:literal></eyo:list></eyo:print></eyo:start_stmt></eyo:content></eyo:workspace></xml>'
          }, {
            title: 'Bonjour...',
            xml: '<xml xmlns="http://www.w3.org/1999/xhtml" xmlns:eyo="urn:edython:1.0"><eyo:workspace><eyo:content><eyo:start_stmt x="300" y="200"><eyo:assignment eyo:name="prénom" eyo:flow="next"><eyo:list eyo:slot="assigned"><eyo:input eyo:slot="O"><eyo:literal eyo:slot="expression">\'Quel est votre prénom ?\'</eyo:literal></eyo:input></eyo:list><eyo:print  eyo:flow="next"><eyo:list eyo:slot="arguments"><eyo:literal eyo:slot="O">\'Bonjour\'</eyo:literal><eyo:identifier eyo:name="prénom" eyo:slot="f"></eyo:identifier></eyo:list></eyo:print></eyo:assignment></eyo:start_stmt></eyo:content></eyo:workspace></xml>'
          }, {
            title: 'Somme des entiers',
            xml: '<xml xmlns="http://www.w3.org/1999/xhtml" xmlns:eyo="urn:edython:1.0"><eyo:workspace><eyo:content><eyo:start_stmt x="300" y="280"><eyo:stmt eyo:comment="1) Demander un nombre à l\'utilisateur" eyo:flow="next"><eyo:assignment eyo:name="réponse" eyo:flow="next"><eyo:list eyo:slot="assigned"><eyo:input eyo:slot="O"><eyo:literal eyo:slot="expression">\'Donner un nombre entier positif\'</eyo:literal></eyo:input></eyo:list><eyo:stmt eyo:comment="2) Convertir la réponse en nombre entier" eyo:flow="next"><eyo:assignment eyo:name="n" eyo:flow="next"><eyo:list eyo:slot="assigned"><eyo:call eyo:name="int" eyo:slot="O"><eyo:list eyo:slot="arguments"><eyo:identifier eyo:name="réponse" eyo:slot="O"></eyo:identifier></eyo:list></eyo:call></eyo:list><eyo:stmt eyo:comment="3) Initialiser la somme à 0" eyo:flow="next"><eyo:assignment eyo:name="somme" eyo:flow="next"><eyo:list eyo:slot="assigned"><eyo:literal eyo:slot="O">0</eyo:literal></eyo:list><eyo:stmt eyo:comment="4) Calculer la somme" eyo:flow="next"><eyo:for eyo:flow="next"><eyo:list eyo:slot="for"><eyo:identifier eyo:name="i" eyo:slot="O"></eyo:identifier></eyo:list><eyo:list eyo:slot="in"><eyo:range eyo:slot="O"><eyo:list eyo:slot="arguments"><eyo:a_expr eyo:operator="+" eyo:slot="O"><eyo:identifier eyo:name="n" eyo:slot="lhs"></eyo:identifier><eyo:literal eyo:slot="rhs">1</eyo:literal></eyo:a_expr></eyo:list></eyo:range></eyo:list><eyo:assignment eyo:name="somme" eyo:flow="suite"><eyo:list eyo:slot="assigned"><eyo:a_expr eyo:operator="+" eyo:slot="O"><eyo:identifier eyo:name="somme" eyo:slot="lhs"></eyo:identifier><eyo:identifier eyo:name="i" eyo:slot="rhs"></eyo:identifier></eyo:a_expr></eyo:list></eyo:assignment><eyo:stmt eyo:comment="4) Afficher le résultat" eyo:flow="next"><eyo:print eyo:flow="next"><eyo:list eyo:slot="arguments"><eyo:literal eyo:slot="O">\'La somme des\'</eyo:literal><eyo:identifier eyo:name="n" eyo:slot="f"></eyo:identifier><eyo:literal eyo:slot="o">\'premiers entiers est\'</eyo:literal><eyo:identifier eyo:name="somme" eyo:slot="x"></eyo:identifier></eyo:list></eyo:print></eyo:stmt></eyo:for></eyo:stmt></eyo:assignment></eyo:stmt></eyo:assignment></eyo:stmt></eyo:assignment></eyo:stmt></eyo:start_stmt></eyo:content></eyo:workspace></xml>'
          }
        ]
      }
    },
