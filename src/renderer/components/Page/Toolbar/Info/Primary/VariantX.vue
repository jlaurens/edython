<template>
  <b-button-group class="mx-1">
    <b-dropdown :id="id" class="eyo-dropdown" v-if="options && options.length" variant="outline-secondary">
      ...
      <b-dropdown-item-button v-for="variant in options" v-on:click="selected = variant" :key="variant.key" class="eyo-info-primary-variant eyo-code" v-html="variant.content"></b-dropdown-item-button>
    </b-dropdown>
