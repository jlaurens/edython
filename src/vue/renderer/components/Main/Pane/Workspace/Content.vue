...
export default {
  ...
  watch: {
    sliding (newValue, oldValue) { // eslint-disable-line no-unused-vars
    ...
    flyoutCategory (newValue, oldValue) { // eslint-disable-line no-unused-vars
    ...
    isBasic (newValue, oldValue) { // eslint-disable-line no-unused-vars
