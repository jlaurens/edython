      ...
      <b-btn-group>
        ...
        >
          <b-dd-item-button
            ...
            @click="$root.$emit('document-rename')"
          >
            {{ $$t('brick.pane.content.document-rename') }}
          </b-dd-item-button>
          <b-dd-divider
            v-if="isWorkspace"
          />
          <b-dd-item-button
            ...
            :key="pane"
            class="eyo-code"
            @click="selectedPane = pane"
          >
            {{ $$t(`brick.pane.${pane.replace(/(^|\s)\S/g, l => l.toUpperCase())}`) }}
          </b-dd-item-button>
          <b-dd-divider />
          <b-dd-item-button
...
export default {
  name: 'EyoWorkspaceManagementToolbar',
  components: {
    IconBase,
    IconLayout,
    IconMenu
