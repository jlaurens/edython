...
describe('Assignment', function() {
  ...
  it('Expression only', function() {
    ...
    chai.assert(input.magnet.t_eyo === d2, 'MISSED C8N 2')
    d1.block_.dispose()
    eYo.Test.tearItDown()
  })
...
describe('One brick: annotated_assignment_stmt', function() {
  ...
  it('target', function() {
    ...
    d3.block_.dispose() // orphan recovery: the old d2 brick has been reconnected into d3
    eYo.Test.dlgt(d_main, 'assignment_stmt')
...
describe('Initalize augmented_assignment_stmt', function() {
  eYo.Brick.Manager.getModel(eYo.T3.Expr.augmented_stmt)
