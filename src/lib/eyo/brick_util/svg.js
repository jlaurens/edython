 ...
 */
eYo.Svg.addClass = function(element, className) {
  goog.dom.classlist
 ...
 */
eYo.Svg.removeClass = function(element, className) {
  var classes = element.getAttribute('class');
  if ((' ' + classes + ' ').indexOf(' ' + className + ' ') == -1) {
    return false;
  }
 ...
 */
eYo.Svg.prototype.brickInit = function (node) {
  var svg = node.ui.svg = {}
  // groups:
 ...
 * @param {!Object} node  the node the driver acts on
 */
eYo.Svg.prototype.brickDispose = function (node) {
  var svg = node.ui.svg
 ...
 */
eYo.Svg.prototype.brickSvgGroup = function(node) {
 ...
 * @private
 */
eYo.Svg.prototype.brickCanDraw = function (node) {
 ...
 * @private
 */
eYo.Svg.prototype.contourAboveParent_ = function (node) {
 ...
 * @private
 */
eYo.Svg.prototype.brickGetBBox = function (node) {
 ...
 * @private
 */
eYo.Svg.prototype.brickHasSelect = function (node) {
 ...
 * @private
 */
eYo.Svg.prototype.pathSelectDef_ = function (node) {
 ...
 * @private
 */
eYo.Svg.prototype.pathDef_ = function (node) {
 ...
 * @private
 */
eYo.Svg.prototype.pathConnectionDef_ = function (node) {
 ...
 * @private
 */
eYo.Svg.prototype.pathBBoxDef_ = function (node) {
 ...
 * @private
 */
eYo.Svg.prototype.brickWillRender = function (node, recorder) {
  var svg = node.ui.svg
  if (svg.group_) {
 ...
 * @private
 */
eYo.Svg.prototype.brickDidRender = function (node, recorder) {
}
 ...
 * @param {*} def
 */
eYo.Svg.prototype.updatePath_ = function (node, path, def) {
  if (path) {
    if (def) {
      try {
        var d = def(node)
 ...
 * @private
 */
eYo.Svg.prototype.brickUpdateShape = function (node) {
  var svg = node.ui.svg
 ...
 * @private
 */
eYo.Svg.prototype.brickDrawModelBegin = function (node, io) {
  io.steps = []
}
 ...
 * @private
 */
eYo.Svg.prototype.brickDrawModelEnd = function (node, io) {
  var d = io.steps.join(' ')
 ...
 */
eYo.Svg.prototype.brickParentWillChange = function (node, newParent) {
  var svg = node.ui.svg
  if (node.parent) {
 ...
 */
eYo.Svg.prototype.brickParentDidChange = function (node, oldParent) {
  if (node.parent) {
    var ui = node.ui
    var svg = ui.svg
    var g = svg.group_
    ...
    node.moveMagnets_(newXY.x - oldXY.x, newXY.y - oldXY.y)
 ...
 * @param {!Object} node  the node the driver acts on
 */
eYo.Svg.prototype.brickUpdateDisabled = function (node) {
  var brick = node
  var svg = node.ui.svg
 ...
 */
eYo.Svg.prototype.brickMenuShow = function (node, menu) {
  var svg = node.ui.svg
 ...
 * @param {!Object} node  the node the driver acts on
 */
eYo.Svg.prototype.brickUpdateWrapped = function (node) {
  var svg = node.ui.svg
 ...
 * @private
 */
eYo.Svg.prototype.brickSendToFront = function (node) {
  var eyo = node
  var parent
 ...
 * @private
 */
eYo.Svg.prototype.brickSendToBack = function (node) {
  var eyo = node
  var parent
  while ((parent = eyo.surround)) {
    eyo = parent
 ...
 * @return {boolean}
 */
eYo.Svg.prototype.brickSetOffset = function (node, dc, dl) {
  var svg = node.ui.svg
 ...
 * @package
 */
eYo.Svg.prototype.brickSetOffsetDuringDrag = function(node, dx, dy) {
  var svg = node.ui.svg
 ...
 * @return {boolean}
 */
eYo.Svg.prototype.brickSetOffset = function (node, dx, dy) {
  var svg = node.ui.svg
 ...
 */
eYo.Svg.prototype.brickTranslate = function(node, x, y) {
 ...
 *     workspace coordinates.
 */
eYo.Svg.prototype.brickXYInSurface = function (node) {
  var x = 0
  var y = 0
  var brick = node
 ...
 * @param {!Object} node  the node the driver acts on
 */
eYo.Svg.prototype.brickHilightAdd = function (node) {
  var svg = node.ui.svg
 ...
 * @param {!Object} node  the node the driver acts on
 */
eYo.Svg.prototype.brickHilightRemove = function (node) {
 ...
 * @param {!Object} node  the node the driver acts on
 */
eYo.Svg.prototype.brickSelectAdd = function (node) {
  var svg = node.ui.svg
 ...
 * @param {!Object} node  the node the driver acts on
 */
eYo.Svg.prototype.brickSelectRemove = function (node) {
 ...
 * @param {!Object} node  the node the driver acts on
 */
eYo.Svg.prototype.brickMagnetAdd = function (node) {
  var svg = node.ui.svg
 ...
 * @param {!Object} node  the node the driver acts on
 */
eYo.Svg.prototype.brickConnectionRemove = function (node) {
 ...
 * @param {!Object} node  the node the driver acts on
 */
eYo.Svg.prototype.brickStatusTopAdd = function (node) {
 ...
 * @param {!Object} node  the node the driver acts on
 */
eYo.Svg.prototype.brickStatusTopRemove = function (node) {
 ...
 * @param {!Object} node  the node the driver acts on
 */
eYo.Svg.prototype.brickStatusSelectAdd = function (node) {
  var svg = node.ui.svg
  var g = svg.group_
 ...
 * @param {!Object} node  the node the driver acts on
 */
eYo.Svg.prototype.brickStatusSelectRemove = function (node) {
  var svg = node.ui.svg
  var g = svg.group_
 ...
 * @param {!Object} node  the node the driver acts on
 */
eYo.Svg.prototype.brickDisplayedGet = function (node) {
  var g =  node.ui.svg.group_
  if (g) {
    return g.style.display !== 'none'
  }
 ...
 */
eYo.Svg.prototype.brickDisplayedSet = function (node, visible) {
  var svg =  node.ui.svg
  var g =  svg.group_
  if (g) {
 ...
 * @private
 */
eYo.Svg.prototype.brickHide = function (node) {
  var svg = node.ui.svg
  var root = svg.group_
  if (root) {
 ...
 * @private
 */
eYo.Svg.prototype.brickDrawSharp = function (node, visible) {
 ...
 */
eYo.Svg.prototype.brickSetParent = function (node, parent) {
  var svg = node.ui.svg
  if (parent) {
    var p_svg = parent.ui.svg
 ...
 * @param {!eYo.Brick} field  the node the driver acts on
 */
eYo.Svg.prototype.brickAtTop = function (node) {
  var g = node.ui.svg.group_
  // Move this brick up the DOM.  Keep track of x/y translations.
 ...
 * @param {!String} mode  The display mode for bocks.
 */
eYo.Svg.prototype.setBlockDisplayMode = mode => {
