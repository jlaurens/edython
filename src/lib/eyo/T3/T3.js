...
// core expressions
  ...
  call_expr                 /*   ::= primary "(" [argument_list [","] | comprehension] ")" (Primaries) */ : "eyo:call_expr",
...
eYo.T3.Expr.Check.key_datum = eYo.T3.Expr.Check.key_datum_list
...
eYo.T3.Xml.fromDom = { // count 28
    ...
    literal: [eYo.T3.Expr.shortstringliteral, eYo.T3.Expr.longbytesliteral, eYo.T3.Expr.floatnumber, eYo.T3.Expr.shortbytesliteral, eYo.T3.Expr.imagnumber, eYo.T3.Expr.integer, eYo.T3.Expr.longstringliteral, eYo.T3.Expr.longliteral],
    ...
    comparison: [eYo.T3.Expr.object_comparison, eYo.T3.Expr.number_comparison],
    ...
    else: [eYo.T3.Stmt.else_part, eYo.T3.Stmt.try_else_part, eYo.T3.Stmt.last_else_part],
