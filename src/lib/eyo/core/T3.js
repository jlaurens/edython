// This file was generated by "python types.py" on 2018-05-19 09:54:59.968393
...
// core expressions
  ...
  power_s3d                 : /*   ::= await_or_primary "**" u_expr_all                   (The power operator) */ "eyo:power_s3d",
  u_expr_s3d                : /*   ::= "-" u_expr_all | "+" u_expr_all | "~" u_expr_all   (Unary arithmetic and bitwise operations) */ "eyo:u_expr_s3d",
  m_expr_s3d                : /*   ::= m_expr_all "*" u_expr_all | m_expr_all "@" m_expr_all | m_expr_all "//" u_expr_all | m_expr_all "/" u_expr_all | m_expr_all "%" u_expr_all (Binary arithmetic operations) */ "eyo:m_expr_s3d",
  a_expr_s3d                : /*   ::= a_expr_all "+" m_expr_all | a_expr_all "-" m_expr_all (Binary arithmetic operations) */ "eyo:a_expr_s3d",
  shift_expr_s3d            : /*   ::= shift_expr_all ( "<<" | ">>" ) a_expr_all          (Shifting operations) */ "eyo:shift_expr_s3d",
  and_expr_s3d              : /*   ::= and_expr_all "&" shift_expr_all                    (Binary bitwise operations) */ "eyo:and_expr_s3d",
  xor_expr_s3d              : /*   ::= xor_expr_all "^" and_expr_all                      (Binary bitwise operations) */ "eyo:xor_expr_s3d",
  or_expr_s3d               : /*   ::= or_expr_all "|" xor_expr_all                       (Binary bitwise operations) */ "eyo:or_expr_s3d",
  ...
  not_test_s3d              : /*   ::= "not" not_test_all                                 (Boolean operations) */ "eyo:not_test_s3d",
  and_test_s3d              : /*   ::= and_test_all "and" not_test_all                    (Boolean operations) */ "eyo:and_test_s3d",
  or_test_s3d               : /*   ::= or_test_all "or" and_test_all                      (Boolean operations) */ "eyo:or_test_s3d",
...
// wrappers, like starred_item ::=  expression | star_expr
  ...
  key_datum_all             : /*   ::= or_expr_star_star | key_datum_s3d                  (Atoms) */ "eyo:key_datum_all",
  ...
  power_all                 : /*   ::= await_or_primary | power_s3d                       (The power operator) */ "eyo:power_all",
  u_expr_all                : /*   ::= power_all | u_expr_s3d                             (Unary arithmetic and bitwise operations) */ "eyo:u_expr_all",
  m_expr_all                : /*   ::= u_expr_all | m_expr_s3d                            (Binary arithmetic operations) */ "eyo:m_expr_all",
  a_expr_all                : /*   ::= m_expr_all | a_expr_s3d                            (Binary arithmetic operations) */ "eyo:a_expr_all",
  shift_expr_all            : /*   ::= a_expr_all | shift_expr_s3d                        (Shifting operations) */ "eyo:shift_expr_all",
  and_expr_all              : /*   ::= shift_expr_all | and_expr_s3d                      (Binary bitwise operations) */ "eyo:and_expr_all",
  xor_expr_all              : /*   ::= and_expr_all | xor_expr_s3d                        (Binary bitwise operations) */ "eyo:xor_expr_all",
  or_expr_all               : /*   ::= xor_expr_all | or_expr_s3d                         (Binary bitwise operations) */ "eyo:or_expr_all",
  not_test_all              : /*   ::= comparison | not_test_s3d                          (Boolean operations) */ "eyo:not_test_all",
  and_test_all              : /*   ::= not_test_all | and_test_s3d                        (Boolean operations) */ "eyo:and_test_all",
  or_test_all               : /*   ::= and_test_all | or_test_s3d                         (Boolean operations) */ "eyo:or_test_all",
