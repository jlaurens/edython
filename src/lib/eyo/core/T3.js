// This file was generated by "python types.py" on 2018-06-20 15:47:46.158008
...
// other simple statements
  ...
  call_stmt                : /*   ::= call                                               (Coroutines) */ "eyo:call_stmt",
  module_call_stmt         : /*   ::= module_call                                        (Coroutines) */ "eyo:module_call_stmt",
  builtin_print_stmt       : /*   ::= builtin_print_expr                                 (Coroutines) */ "eyo:builtin_print_stmt",
  builtin_range_stmt       : /*   ::= builtin_range_expr                                 (Coroutines) */ "eyo:builtin_range_stmt",
  random_import_stmt       : /*   ::= "import random"                                    (Coroutines) */ "eyo:random_import_stmt",
  random_call_stmt         : /*   ::= random."name" (...)                                (Coroutines) */ "eyo:random_call_stmt",
  random_seed_stmt         : /*   ::= "random.seed" (a=None, version=2)                  (Coroutines) */ "eyo:random_seed_stmt",
// compound statements
}
...
// core expressions
  ...
  call                      : /*   ::= primary "(" argument_list_comprehensive ")"        (Primaries) */ "eyo:call",
  ...
  base_call                 : /*   ::= "name" "(" argument_list_comprehensive ")"         (Primaries) */ "eyo:base_call",
  module_call               : /*   ::= module."name" "(" argument_list_comprehensive ")"  (Primaries) */ "eyo:module_call",
  ...
  builtin_range_expr        : /*   ::= "range(" range_argument_list ")"                   (Coroutines) */ "eyo:builtin_range_expr",
  ...
  random_call               : /*   ::= random."name" (...)                                (Coroutines) */ "eyo:random_call",
  random_randrange          : /*   ::= "random.randrange" (start, stop[, step])           (Coroutines) */ "eyo:random_randrange",
// lists
...
eYo.T3.Xml.fromDom = { // count 29
    ...
    range: [eYo.T3.Stmt.builtin_range_stmt, eYo.T3.Expr.builtin_range_expr],
