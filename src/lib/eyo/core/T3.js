// This file was generated by "python types.py" on 2019-03-12 17:36:11.577304
...
// core expressions
  ...
  target_annotated          : /*   ::= target || identifier_annotated                     (Assignment statements) */ "eyo:target_annotated",
...
// wrappers, like starred_item ::=  expression | star_expr
  ...
  augtarget                 : /*   ::= identifier | attributeref | subscription | slicing | dotted_name (Assignment statements) */ "eyo:augtarget",
  ...
  assignment_value_list     : /*   ::= value_list | assignment_chain                      (Assignment statements) */ "eyo:assignment_value_list",
  augassigned_list          : /*   ::= expression | yield_expression                      (Assignment statements) */ "eyo:augassigned_list",
  target_unstar             : /*   ::= identifier | parenth_target_list | bracket_target_list | attributeref | dotted_name | subscription | slicing | named_attributeref | named_subscription | named_slicing (Assignment statements) */ "eyo:target_unstar",
...
eYo.T3.Expr.Check = {
  ...
  assignment_value_list: [ // count 44
    eYo.T3.Expr.longformattedliteral,
    eYo.T3.Expr.shortformattedliteral,
    eYo.T3.Expr.parenth_form,
    eYo.T3.Expr.list_display,
