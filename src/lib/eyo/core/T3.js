// This file was generated by "python types.py" on 2018-09-12 11:46:45.837228
...
// other simple statements
  ...
  base_call_stmt           : /*   ::= base_call_expr                                     (Coroutines) */ "eyo:base_call_stmt",
  module__call_stmt        : /*   ::= module__call_expr                                  (Primaries) */ "eyo:module__call_stmt",
  builtin__print_stmt      : /*   ::= builtin__print_expr                                (Primaries) */ "eyo:builtin__print_stmt",
  random__import_stmt      : /*   ::= "import random"                                    (Primaries) */ "eyo:random__import_stmt",
  random__call_stmt        : /*   ::= random__call_expr                                  (Primaries) */ "eyo:random__call_stmt",
  math__import_stmt        : /*   ::= "import math"                                      (Primaries) */ "eyo:math__import_stmt",
  math__call_stmt          : /*   ::= math__call_expr                                    (Primaries) */ "eyo:math__call_stmt",
  turtle__import_stmt      : /*   ::= "import turtle"                                    (Primaries) */ "eyo:turtle__import_stmt",
  turtle__call_stmt        : /*   ::= turtle__call_expr                                  (Primaries) */ "eyo:turtle__call_stmt",
  turtle__config_stmt      : /*   ::= turtle.setConfig(...)                              (Primaries) */ "eyo:turtle__config_stmt",
  turtle__setup_stmt       : /*   ::= "edython.setupTurtle()"                            (Primaries) */ "eyo:turtle__setup_stmt",
  cmath__import_stmt       : /*   ::= "import cmath"                                     (Primaries) */ "eyo:cmath__import_stmt",
  cmath__call_stmt         : /*   ::= cmath__call_expr                                   (Primaries) */ "eyo:cmath__call_stmt",
// compound statements
}
...
// core expressions
  ...
  base_call_expr            : /*   ::= "name" "(" argument_list_comprehensive ")"         (Primaries) */ "eyo:base_call_expr",
  module__call_expr         : /*   ::= "module".foo (args)                                (Primaries) */ "eyo:module__call_expr",
  ...
  builtin__print_expr       : /*   ::= "print(" argument_list ")"                         (Primaries) */ "eyo:builtin__print_expr",
  print_argument_list_comprehensive : /*   ::= subclass of argument_list_comprehensive            (Primaries) */ "eyo:print_argument_list_comprehensive",
  random__call_expr         : /*   ::= random."name" (...)                                (Primaries) */ "eyo:random__call_expr",
  random__randrange         : /*   ::= "random.randrange"                                 (Primaries) */ "eyo:random__randrange",
  math__call_expr           : /*   ::= math."name" (...)                                  (Primaries) */ "eyo:math__call_expr",
  math__const               : /*   ::= math."name"                                        (Primaries) */ "eyo:math__const",
  turtle__call_expr         : /*   ::= turtle."name" (...)                                (Primaries) */ "eyo:turtle__call_expr",
  cmath__call_expr          : /*   ::= cmath."name" (...)                                 (Primaries) */ "eyo:cmath__call_expr",
  cmath__const              : /*   ::= cmath."name"                                       (Primaries) */ "eyo:cmath__const",
// lists
