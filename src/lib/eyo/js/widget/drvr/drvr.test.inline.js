// This file was generated by "prepare.py" on 2020-09-10 16:16:45.952155

describe(`Inline tests at widget/drvr/drvr.js`, function () {
  this.timeout(20000)
...
//    eYo.mixinFR(eYo.drvr._p, {
  describe(`eYo.drvr extensions`, function () {
//      /**
//       * Turns the given string into a formatted driver Id.
//       * @param {String} id
//       */
//      getDrvrId (id) {
    it(`getDrvrId`, function () {
...
//  eYo.o3d.newC9r(eYo.drvr, eYo.$$.Handler, {
  describe(`eYo.drvr[eYo.$$.Handler]`, function () {
    it(`Basics`, function () {
...
//      },
      it(`frozen or forbidden`, function () {
...
//  
//  eYo.mixinFR(eYo.drvr._p, {
  describe(`eYo driver methods`, function () {
...
//     */
//    uiMerge (model) {
    it(`eYo.Drvr$._p.uiMerge`, function () {
      var mngr = eYo.drvr.newNS()
      mngr.newDrvrC9r('Foo', {
        init (key, owner, ...$) {
          owner.flag(...$, 4)
...
//  eYo.mixinFR(eYo.o4t.Dlgt_p, {
  describe(`eYo.o4t.Dlgt`, function () {
//    /**
//     * Add the driven feature to the receiver's constructor.
//     */
//    drvrEnhanced () {
    describe(`drvrEnhanced`, function () {
      it(`Basics`, function () {
        let mngr = eYo.drvr.newNS()
        mngr.makeC9rBase({
          methods: {
