// This file was generated by "prepare.py" on 2020-09-10 16:16:45.941245

describe(`Inline tests at widget/data/data.js`, function () {
  this.timeout(20000)
...
//    methodsMergeChange (model) {
    it(`methodsMergeChange`, function () {
      var ns, d
      let new_ns = () => {
        flag.reset()
        ns = eYo.data.newNS()
...
//    methodsMergeUnchange (model) {
    it(`methodsMergeUnchange`, function () {
      var ns, d
      let new_ns = () => {
        flag.reset()
        ns = eYo.data.newNS()
...
//    methodsMergeValidate (model) {
    it(`methodsMergeValidate`, function () {
      var ns, d
      let new_ns = () => {
        flag.reset()
        ns = eYo.data.newNS()
...
//    methodsMergeSynchronize (model) {
    it(`methodsMergeSynchronize`, function () {
      var ns, d
      let new_ns = () => {
        flag.reset()
        ns = eYo.data.newNS()
...
//    methodsMergeConsolidate (model) {
    it(`methodsMergeConsolidate`, function () {
      var ns, d
      let new_ns = () => {
        flag.reset()
        ns = eYo.data.newNS()
...
//    methodsMergeFilter (model) {
    it(`methodsMergeFilter`, function () {
      var ns, d
      let new_ns = () => {
        flag.reset()
        ns = eYo.data.newNS()
