...
#SQLiteGLOB operator is used to match only text values against a pattern that you specifiy using wildcards
#If the search expression can be matched to the pattern, the GLOB operator returns True which is 1
#It is similar to the LIKE operator, but GLOB is case sensitive
