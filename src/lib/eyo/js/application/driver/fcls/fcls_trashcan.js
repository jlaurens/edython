...
eYo.provide('eYo.ns.Fcls.TrashCan')
 ...
 */
eYo.ns.Fcls.TrashCan.prototype.openSet = eYo.Do.nothing

/**
 * Place the given trash can.
 * @param {eYo.TrashCan} trashCan  The trash can we must place.
 */
eYo.ns.Fcls.TrashCan.prototype.place = eYo.Do.nothing

/**
 * Get the given trash can's client rect.
 * @param {eYo.TrashCan} trashCan  The trash can we must query.
 */
eYo.ns.Fcls.TrashCan.prototype.clientRect = eYo.Do.nothing
