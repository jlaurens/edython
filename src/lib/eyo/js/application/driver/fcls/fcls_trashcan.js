 ...
 * @param {eYo.widget.TrashCan} trashCan  The trash can we must initialize the UI.
 */
// eYo.fcls.TrashCan.prototype.doInitUI = eYo.do.nothing

/**
 * Dispose of the trash can UI.
 * @param {eYo.widget.TrashCan} trashCan  The trash can we must dispose the UI of.
 */
// eYo.fcls.TrashCan.prototype.doDisposeUI = eYo.do.nothing

/**
 * Is the given trash can open.
 * @param {eYo.widget.TrashCan} trashCan  The trash can we must query.
 */
eYo.fcls.TrashCan.prototype.openGet = eYo.do.nothing

/**
 * Set the given trash can open status.
 * @param {eYo.widget.TrashCan} trashCan  The trash can we must set.
 ...
 * @param {eYo.widget.TrashCan} trashCan  The trash can we must place.
 */
