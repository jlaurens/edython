...
eYo.ns.Svg.makeDriverClass('Field', {
  /**
  ...
  initUI (field) {
    ...
    if (!(field.css_class_ = (field.model && field.model.css_class) || (field.status && `eyo-code-${field.status}`))) {
      field.css_class_ = eYo.ns.Svg.getCssClassForText(field.text)
    }
    ...
    if (field.isTextInput) {
      g = svg.group_ = eYo.ns.Svg.newElement('g', {}, g)
      dom.borderRect_ = eYo.ns.Svg.newElement('rect', {
        rx: 4,
        ry: 4,
      ...
      /** @type {!Element} */
      svg.textElement_ = eYo.ns.Svg.newElement('text', {
        class: field.css_class,
        y: eYo.Font.totalAscent
      }, g)
    } else {
      g = svg.group_ = svg.textElement_ = eYo.ns.Svg.newElement('text', {
        class: field.css_class,
        y: eYo.Font.totalAscent
      }, g)
    }
 ...
 * @param {*} where
 */
eYo.ns.Svg.Field.prototype.moveTo = function (field, where) {
 ...
 * @param {*} field
 */
eYo.ns.Svg.Field.prototype.updateWidth = function (field) {
 ...
 * @param {boolean} yorn
 */
eYo.ns.Svg.Field.prototype.makeError = function (field, yorn) {
 ...
 * @param {boolean} yorn
 */
eYo.ns.Svg.Field.prototype.makeReserved = function (field, yorn) {
  var g = field.dom.svg.group_
  if (g) {
    (yorn
    ? goog.dom.classlist.add
 ...
 * @param {boolean} yorn
 */
eYo.ns.Svg.Field.prototype.makePlaceholder = function (field, yorn) {
  var g = field.dom.svg.group_
  g && (yorn
    ? goog.dom.classlist.add
 ...
 * @param {boolean} yorn
 */
eYo.ns.Svg.Field.prototype.makeComment = function (field, yorn) {
  var g = field.dom.svg.group_
  g && (yorn
    ? goog.dom.classlist.add
    : goog.dom.classlist.remove)(g,
 ...
 */
eYo.ns.Svg.Field.prototype.displayedGet = function (field) {
  var g = field.dom.svg.group_
 ...
 * @param {boolean} yorn
 */
eYo.ns.Svg.Field.prototype.displayedSet = function (field, yorn) {
  var g = field.dom.svg.group_
  if (yorn) {
 ...
 * @param {boolean} yorn
 */
eYo.ns.Svg.Field.prototype.displayedUpdate = function (field) {
 ...
 * @param {eYo.Field} field
 */
eYo.ns.Svg.Field.prototype.updateEditable = function(field) {
 ...
 */
eYo.ns.Svg.Field.prototype.textRemove = function (field) {
 ...
 * @param {Object} field  the node the driver acts on
 */
eYo.ns.Svg.Field.prototype.textCreate = function (field) {
 ...
 * @param {Object} field  the node the driver acts on
 */
eYo.ns.Svg.Field.prototype.textUpdate = function (field) {
 ...
 * @param {*} field
 */
eYo.ns.Svg.Field.prototype.setVisualAttribute = function (field) {
 ...
 * @private
 */
eYo.ns.Svg.Field.prototype.getAbsoluteWhere_ = function(field) {
 ...
 * @private
 */
eYo.ns.Svg.Field.prototype.getDisplayText_ = function(field) {
  var text = field.text_
  if (!text) {
    // Prevent the field from disappearing if empty.
    return eYo.ns.Svg.NBSP;
  }
  // Replace whitespaces with non-breaking spaces so the text doesn't collapse.
  return text.replace(/\s/g, eYo.ns.Svg.NBSP);
}
 ...
 * @private
 */
eYo.ns.Svg.onFieldMouseDown_ = function(e) {
