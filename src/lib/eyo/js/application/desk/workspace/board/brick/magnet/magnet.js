...
/**
 *
 * @param {eYo.ns.Brick.Dflt} brick  brick is the owner
 */
 ...
 * Class for a magnet.
 * 
 * @param {eYo.ns.Brick|eYo.Slot} owner  the immediate owner of this magnet. When not a brick, it is directly owned by a brick.
...
goog.inherits(eYo.Magnet, eYo.ns.UI.Owned2)
...
Object.defineProperties(eYo.Magnet.prototype, {
  model_: { value: eYo.NA, writable: true},
  type_: { value: eYo.NA, writable: true},
  hidden_: { value: eYo.NA, writable: true},
  wrapped_: { value: eYo.NA, writable: true},
  promised_: { value: eYo.NA, writable: true},
  check_: {value: eYo.NA, writable: true},
  name_: { value: eYo.NA, writable: true},
  visible_: { value: eYo.NA, writable: true},
})
...
Object.defineProperties(eYo.Magnet.prototype, {
  ...
  optional_: {value: false, writable: true},
})
...
Object.defineProperties(eYo.Magnet.prototype, {
  ...
  target: {
     ...
     * @param {eYo.ns.Brick.Dflt} [newValue] 
     */
    set (newValue) {
      if (newValue) {
  ...
  function () {
    ...
    if (!t9k) {
      ...
      eYo.Events.disableWrap(
        () => {
          var brick = this.brick
          t9k = eYo.ns.Brick.newReady(brick, this.wrapped_, brick.id + '.wrapped:' + this.name_)
