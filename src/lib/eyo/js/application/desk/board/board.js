 ...
 * @param {eYo.view.Desk|eYo.view.Workspace|eYo.section.C3sBase} owner.
 * @constructor
 */
eYo.board.makeC3sBase({
  aliases: {
...
eYo.board.newC3s('Main', {
  ...
  properties: {
    board: {
      value () {
        return new eYo.board.C3sBase(this, {
    ...
    isDragger: {
      get () {
        return this.owner__ instanceof eYo.board.C3sBase
      },
    },
    /**
 ...
 */
eYo.board.C3sBase_p.didScale = function() {
 ...
 */
eYo.board.C3sBase_p.getTopBricks = function(ordered) {
 ...
 */
eYo.board.C3sBase_p.clear = function() {
 ...
 *     create a new id.
 * @return {!eYo.brick.C3sBase} The created brick.
 */
eYo.board.C3sBase_p.newBrick = function (type, opt_id) {
 ...
 */
eYo.board.C3sBase_p.addChangeListener = function(func) {
 ...
 */
eYo.board.C3sBase_p.removeChangeListener = function(func) {
 ...
 */
eYo.board.C3sBase_p.getBrickById = eYo.board.C3sBase_p.getBrickById = function(id) {
 ...
 */
eYo.board.C3sBase_p.allInputsFilled = function(opt_shadowBricksAreFilled) {
 ...
 * @private
 */
eYo.board.C3sBase_p.resizesEnabled_ = true
 ...
 * @private
 */
eYo.board.C3sBase_p.lastPageScroll_ = null;
 ...
 */
eYo.board.C3sBase_p.configureContextMenu = eYo.NA
 ...
 */
eYo.board.C3sBase_p.setResizeHandlerWrapper = function(handler) {
 ...
 * NB: No css styling.
 */
eYo.board.C3sBase_p.updateMetrics = function() {
 ...
 */
eYo.board.C3sBase_p.metricsDidChange = function() {
  this.place()
}
 ...
 */
eYo.board.C3sBase_p.resizePort = function() {
 ...
 */
eYo.board.C3sBase_p.layout = function() {
  this.updateMetrics()
  this.place()
 ...
 * chromes. (e.g. window layout).
 */
eYo.board.C3sBase_p.place = function() {
 ...
 * scroll position.
 */
eYo.board.C3sBase_p.updateScreenCalculationsIfScrolled =
    function() {
 ...
 */
eYo.board.C3sBase_p.updateScreenCalculations_ = eYo.doNothing

/**
 * Move the receiver to the new coordinates given by its metrics' scroll.
 */
eYo.board.C3sBase_p.move = function() {
 ...
 */
eYo.board.C3sBase_p.moveTo = function(xy) {
 ...
 */
eYo.board.C3sBase_p.render = function() {
 ...
 */
eYo.board.C3sBase_p.highlightBrick = function(id, opt_state) {
  if (opt_state === eYo.NA) {
 ...
 */
eYo.board.C3sBase_p.paste = function () {
 ...
 */
eYo.board.C3sBase_p.inDeleteArea = function(motion) {
  var xy = motion.where
 ...
 */
eYo.board.C3sBase_p.eventWhere = function(e) {
 ...
 */
eYo.board.C3sBase_p.markFocused = function() {
 ...
 */
eYo.board.C3sBase_p.zoom = function(center, amount) {
 ...
 */
eYo.board.C3sBase_p.zoomCenter = function(type) {
 ...
 */
eYo.board.C3sBase_p.scrollPage = function(horizontally, increase) {
 ...
 */
eYo.board.C3sBase_p.zoomToFit = function() {
 ...
 * Center the board.
 */
eYo.board.C3sBase_p.scrollCenter = function() {
 ...
 * @public
 */
eYo.board.C3sBase_p.centerOnBrick = function(id) {
  if (!this.scrollbar) {
 ...
 */
eYo.board.C3sBase_p.setResizesEnabled = function(enabled) {
 ...
 * @private
 */
eYo.board.C3sBase_p.fromPixelUnit = function(xy) {
 ...
 *
 */
eYo.board.C3sBase_p.getRecover = function () {
 ...
 */
eYo.board.C3sBase_p.fromDom = function (dom) {
 ...
 * @return {Array<string>} An array containing new brick IDs.
 */
eYo.board.C3sBase_p.fromString = function (str) {
 ...
 */
eYo.board.C3sBase_p.toDom = function (opt) {
 ...
 */
eYo.board.C3sBase_p.description = function (opt_noId) { // eslint-disable-line
 ...
 * @param {Boolean} [opt_noId]
 */
eYo.board.C3sBase_p.toUTF8ByteArray = function (opt_noId) {
 ...
 * @return {Array<string>} An array containing new brick IDs.
 */
eYo.board.C3sBase_p.fromUTF8ByteArray = function (bytes) {
 ...
 * @param {String} [opt_id]
 */
eYo.board.C3sBase_p.addBrick = function (brick, opt_id, f, ...$) {
  if (!eYo.isStr(opt_id)) {
    $.unshift(f)
 ...
 */
eYo.board.C3sBase_p.removeBrick = function (brick, f, ...$) {
  this.changer.wrap(() => {
 ...
 * IN PROGRESS
eYo.board.C3sBase_p.tidyUp = function (kvargs) {
  // x + y < O / x + y > 0
  var x_plus_y = (l, r) => {
 ...
 * @public
 */
eYo.board.C3sBase_p.scrollBrickTopLeft = function(id) {
  if (!this.scrollbar) {
    console.warn('Tried to scroll a non-scrollable board.')
    return
  }
 ...
 */
eYo.board.C3sBase_p.eventDidFireChange = function(event) {
  let task = () => {
...
eYo.o3d.C3sBase[eYo.$].p6yAliasesMerge({
  'owner.board': 'board',
})

eYo.board.C3sBase_p.logAllConnections = function (comment) {
  comment = comment || ''
  ;[
    'IN',
    'OUT',
