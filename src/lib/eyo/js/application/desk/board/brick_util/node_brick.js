 ...
 */
eYo.py.node.C9rBase_p.suiteInBrick = function (brick) {
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.func_body_suiteInBrick = function (brick) {
  var n = this.n0
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.comment2Brick = function (owner) {
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.typeComment2Brick = function (owner) {
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.simple_stmt2Brick = function (owner) {
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.nAME2Brick = function (owner) {
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.dotted_name2Brick = function (owner) {
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.comp_iter2Brick = function (board) {
 ...
 * @param {eYo.brick.C9rBase} brick  a brick with a 'for' slot.
 */
eYo.py.node.C9rBase_p.comp_forInBrick = function (brick) {
 ...
 * @param {eYo.brick.C9rBase} brick  a brick with a 'for' slot.
 */
eYo.py.node.C9rBase_p.sync_comp_forInBrick = function (brick) {
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.sync_comp_for2Brick = function (board) {
  // 'for' exprlist 'in' or_test [comp_iter]
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.comp_if2Brick = function (board) {
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.for_stmt2Brick = function (board) {
  // 'for' exprlist 'in' testlist ':' suite ['else' ':' suite]
  var b3k = eYo.brick.newReady(eYo.t3.stmt.for_part, board)
  var n = this.n1
  n.exprlistInBrick(b3k.for_b)
  n = n.sibling.sibling
  n.testlistInBrick(b3k.in_b)
  n = n.sibling.sibling
  n.suiteInBrick(b3k)
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.namedexpr_test2Brick = function (board) {
  // test [':=' test]
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.if_stmt2Brick = function (board) {
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.while_stmt2Brick = function (board) {
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.try_stmt2Brick = function (board) {
  /*try_stmt: ('try' ':' suite
           ((except_clause ':' suite)+
            ['else' ':' suite]
            ['finally' ':' suite] |
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.with_stmt2Brick = function (board) {
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.funcdef2Brick = function (board) {
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.classdef2Brick = function (board) {
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.decorated2Brick = function (board) {
  /*
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.decorator2Brick = function (board) {
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.tfpdef2Brick = function (board) {
  /* tfpdef: NAME [':' test] */
 ...
 * @param {eYo.brick.C9rBase} brick  a brick
 */
eYo.py.node.C9rBase_p.typedargslistInBrick = function (brick) {
  var n = this.n0
  /* typedargslist:
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.knownListInBrick = function (brick, toBrick) {
  var n = this.n0
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.do_list = function (brick) {
  var n = this.n0
  do {
...
eYo.py.node.C9rBase_p.exprlistInBrick =
eYo.py.node.C9rBase_p.arglistInBrick =
eYo.py.node.C9rBase_p.testlistInBrick =
eYo.py.node.C9rBase_p.testlist_star_exprInBrick =
eYo.py.node.C9rBase_p.subscriptlistInBrick = eYo.py.node.C9rBase_p.do_list

/**
 * `this` is binary expression.
 * @param {eYo.board|eYo.brick.C9rBase} owner
 * @param {String} type
 * @param {String} op
 */
eYo.py.node.C9rBase_p.binary2Brick = function (owner, type, op) {
  var n0 = this.n0
  var n1
 ...
 * @param {Object} owner
 */
eYo.py.node.C9rBase_p.yield_expr2Brick = function (owner) {
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.yield_exprInBrick = function (brick) {
  var n = this.n1
  if (n) {
    if (n.n1) {
 ...
 */
eYo.py.node.C9rBase_p.yield_exprInListBrick = function (brick) {
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.varargslistInBrick = function (brick) {
 ...
 * @param {eYo.brick.C9rBase} brick  a brick
 */
eYo.py.node.C9rBase_p.dictorsetmakerInBrick = function (brick) {
/*dictorsetmaker: ( ((test ':' test | '**' expr)
  ...
  while (true) { // eslint-disable-line
    if (n.n_type === eYo.py.tkn.DOUBLESTAR) {
      dd = eYo.brick.newReady(brick, eYo.t3.expr.expression_star_star)
 ...
 * @param {eYo.brick.C9rBase} brick a brick
 */
eYo.py.node.C9rBase_p.comprehensionInBrick = function (brick) {
 ...
 */
eYo.py.node.C9rBase_p.comprehension2Brick = function (owner) {
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.dict_comprehension2Brick = function (owner) {
 ...
 * @param {Object} a brick
 */
eYo.py.node.C9rBase_p.testlist_compInBrick = function (brick) {
 ...
 */
eYo.py.node.C9rBase_p.toBrick = function (board) {
 ...
 * @param {Object} a brick or an array of bricks
 */
eYo.py.node.C9rBase_p.toBrick_ = function (board) {
...
*/
  ...
  //TODO: Is it the good one, another case above!!!
