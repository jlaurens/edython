...
/**
 * Convenient shortcut.
 * @param {eYo.brick.BaseC3s} brick  The newly created brick.
...
/**
 * Convenient shortcut.
 * @param {eYo.brick.BaseC3s} brick  The moved brick.
 ...
 * @param {eYo.brick.BaseC3s} brick The brick this event corresponds to.
 ...
 * @param {eYo.brick.BaseC3s} brick The changed brick.
 ...
 * @param {eYo.brick.BaseC3s} brick The created brick.
 * @extends {eYo.event.BrickBase}
 * @constructor
 */
 ...
 * @param {eYo.brick.BaseC3s} brick The deleted brick.
 * @extends {eYo.event.BrickBase}
 * @constructor
 */
...
eYo.data.BaseC3s[eYo.$].methodsMerge({
  /**
