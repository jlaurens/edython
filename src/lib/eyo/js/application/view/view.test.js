// This file was generated by "update.py" on 2020-09-26 09:37:50.409106
...
//  
describe(`Inline tests at application/view/view.js`, function () {
  this.timeout(20000)
...
describe(`Inline tests at application/view/view.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
  describe(`viewEnhanced`, function () {
//  
...
describe(`Inline tests at application/view/view.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
    describe(`eYo.dlgt.BaseC3s_p.viewShortcuts`, function () {
//      viewShortcuts () {
describe(`Inline tests at application/view/view.js`, function () {
  this.timeout(20000)
  beforeEach (function () { eYo.test.setup() })
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
      it(`viewShortcuts (foo_v)`, function () {
//        let _p = this.C3s_p
...
describe(`Inline tests at application/view/view.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
    it(`viewEnhanced/allow`, function () {
...
describe(`Inline tests at application/view/view.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
    it(`viewMerge+viewShortcuts`, function () {
      let ns = eYo.o4t.newNS()
      let C3s = ns.makeBaseC3s(true)
      C3s[eYo.$].viewEnhanced()
      C3s[eYo.$].finalizeC3s()
