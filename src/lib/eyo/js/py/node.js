...
eYo.py.node.BaseC3s_p.be_keyword = function () {
  this.is_keyword = true
  return this
}

eYo.py.node.BaseC3s_p.be_close = function (open) {
  if (open) {
    this.open = open
    open.close = this
  }
...
// eYo.py.node.BaseC3s_p.parent = null
// eYo.py.node.BaseC3s_p.children = null

/**
 * Add a comment to the node or one of its ancestors.
 * @param {eYo.py.tkn.Node} comment  the comment node token to add.
 */
eYo.py.node.BaseC3s_p.pushComment = function (comment) {
  var n = this
