...
eYo.fcls.newDrvrC3s('Brick', {
  methods: {
     ...
     * @param {eYo.brick.BaseC3s} brick to be connected.
     * @param {eYo.brick.BaseC3s} newParent to be connected.
     */
    do_parentWillChange: eYo.doNothing,
    /**
     * The default implementation does nothing.
     * @param {eYo.brick.BaseC3s} oldParent replaced.
     */
    do_parentDidChange: eYo.doNothing,
    /**
     * Returns the bounding box of the node.
     * Defaults implementation returns `eYo.NA`.
     * @param {eYo.brick.BaseC3s} brick - the node the driver acts on
     * @private
     */
 ...
 * The default implementation forwards to the driver.
 */
eYo.drvr.makeForwarder(eYo.brick.BaseC3s_p, 'magnetHilight')

/**
 * Set the parent.
 * @param {eYo.brick.BaseC3s} brick - the brick the driver acts on
 * @param {eYo.brick.BaseC3s} parent - the brick's parent
 */
eYo.doNothing
