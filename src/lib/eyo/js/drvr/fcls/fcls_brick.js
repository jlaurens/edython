 ...
 */
eYo.fcls.newDrvrC3s('Brick', {
  methods: {
    /**
     * The default implementation does nothing.
     * @param {eYo.brick.C3sBase} brick to be connected.
     * @param {eYo.brick.C3sBase} newParent to be connected.
     */
    do_parentWillChange: eYo.doNothing,
    /**
     * The default implementation does nothing.
     * @param {eYo.brick.C3sBase} oldParent replaced.
     */
    do_parentDidChange: eYo.doNothing,
    /**
     * Returns the bounding box of the node.
     * Defaults implementation returns `eYo.NA`.
     * @param {eYo.brick.C3sBase} brick - the node the driver acts on
     * @private
     */
 ...
 * The default implementation forwards to the driver.
 */
eYo.drvr.makeForwarder(eYo.brick.C3sBase_p, 'magnetHilight')

/**
 * Set the parent.
 * @param {eYo.brick.C3sBase} brick - the brick the driver acts on
 * @param {eYo.brick.C3sBase} parent - the brick's parent
 */
eYo.doNothing
