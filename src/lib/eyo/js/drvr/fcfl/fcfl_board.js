 ...
 */
eYo.fcfl.newDrvrC9r('Board')

console.error('NYI')

eYo.board.C9rBase[eYo.$].p6yMerge({
  ui () {
  ...
  bBox: {
    get () {
      //TODO: ?
      return this.rendered && (this.drvr.getBBox(this))
    },
  },
  hasSelect: {
    get () {
...
eYo.board.C9rBase[eYo.$].p6yAliasesMerge({
  'xy': 'where',
})
 ...
 * @param {eYo.board.C9rBase} board - The board to move.
 ...
 * @param {eYo.board.C9rBase} board - the board the driver acts on
 ...
 * @protected
 */
eYo.drvr.makeForwarder(eYo.board.C9rBase_p, 'updateShape')

/**
 * Update the shape of the board.
 * To be subclassed.
 * @param {eYo.board.C9rBase} board - The board of which the shape would need an update
 * @protected
 */
 ...
 * @param {eYo.board.C9rBase} board - the board the driver acts on
 * @param {eYo.magnet.C9rBase} m4t what has been connected in the board
 * @param {eYo.magnet.C9rBase} oldTargetM4t what was previously connected in the board
