 ...
 * @memberof eYo.brick.C9rBase_p.dom
 */
 ...
 * @param {eYo.brick.C9rBase} brick child.
 * @param {eYo.brick.C9rBase} newParent to be connected.
 */
 ...
 * This code is responsible to place the various path
 * in the proper domain of the dom tree.
 * @param {eYo.brick.C9rBase} oldParent child.
 * @param {eYo.brick.C9rBase} oldParent replaced.
 */
 ...
 * @param {eYo.brick.C9rBase} mode  The brick to edit.
