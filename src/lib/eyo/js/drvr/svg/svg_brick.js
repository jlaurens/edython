 ...
 * @memberof eYo.brick.BaseC3s_p.dom
 */
 ...
 * @param {eYo.brick.BaseC3s} brick child.
 ...
 * This code is responsible to place the various path
 * in the proper domain of the dom tree.
 * @param {eYo.brick.BaseC3s} oldParent child.
 ...
 * @param {eYo.brick.BaseC3s} mode  The brick to edit.
