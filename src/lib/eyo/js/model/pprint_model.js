...
eYo.provide('eYo.ns.Model.pprint__module.Item')
eYo.provide('eYo.ns.Model.pprint__module')

eYo.ns.Model.pprint__module = new eYo.ns.Model.Module('pprint__module', 'https://docs.python.org/3.6/library/pprint.html')

/**
 * @constructor
 * @param {*} model
 */
eYo.ns.Model.pprint__module.Item = function (model) {
  eYo.ns.Model.pprint__module.Item.superClass_.constructor.call(this, model)
}

;(function () {

var Item = eYo.ns.Model.pprint__module.Item
 ...
 * module
 */
Item.prototype.module = eYo.ns.Model.pprint__module
...
eYo.ns.Model.pprint__module.setData({
  categories: [
    'module-pprint',
