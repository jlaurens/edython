// This file was generated by "prepare.py" on 2020-09-10 16:16:45.016109
...
//       */
//      makeC9rPrepare () {
    it(`eYo.Dlgt_p.makeC9rPrepare`, function () {
//        eYo.mixinFR(this, {
...
//       */
//      makeC9rInit () {
    it(`eYo.dlgt.C9rBase_p.makeC9rInit`, function () {
//        eYo.mixinFR(this, {
...
//        let K = 'c9rDispose'
//        let f_p = this.$super && this.$super[K]
    it(`eYo.dlgt.C9rBase_p.makeC9rDispose`, function () {
//        if (f_m) {
//          if (XRegExp.exec(f_m.toString(), eYo.xre.function_builtin)) {
//            if (f_p) {
//              var m = {[K] ($this, ...$) {
...
//       */
//      addSubC9r (C9r) {
    it(`addSubC9r + forEachSubC9r + someSubC9r`, function () {
...
//      eYo.mixinRO(_p, model)
    it(`eYo.Dlgt_p.CONSTsMerge`, function () {
      preparator()
      C9r[eYo.$].CONSTsMerge({
        FOO: 'bar',
      })
