// This file was generated by "update.py" on 2020-09-26 09:37:50.514442
...
describe(`Inline tests at core/dlgt/dlgt.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
    it(`eYo.Dlgt_p.makeC3sPrepare`, function () {
//        eYo.mixinFR(this, {
...
describe(`Inline tests at core/dlgt/dlgt.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
    it(`eYo.dlgt.BaseC3s_p.makeC3sInit`, function () {
//        eYo.mixinFR(this, {
...
describe(`Inline tests at core/dlgt/dlgt.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
    it(`eYo.dlgt.BaseC3s_p.makeC3sDispose`, function () {
//        if (f_m) {
//          if (XRegExp.exec(f_m.toString(), eYo.xre.function_builtin)) {
//            if (f_p) {
//              var m = {[K] ($this, ...$) {
...
describe(`Inline tests at core/dlgt/dlgt.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
    it(`addSubC3s + forEachSubC3s + someSubC3s`, function () {
