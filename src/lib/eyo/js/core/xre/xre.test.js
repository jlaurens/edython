// This file was generated by "update.py" on 2020-09-26 09:37:50.694844
...
//  
describe(`Inline tests at core/xre/xre.js`, function () {
  this.timeout(20000)
...
describe(`Inline tests at core/xre/xre.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
  it(`(short|long)stringliteral(Single|Double)`, function () {
...
describe(`Inline tests at core/xre/xre.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
  it(`(short|long)bytesliteral(Single|Double)`, function () {
...
describe(`Inline tests at core/xre/xre.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
  it(`(short|long)bytesliteral(Single|Double)NoPrefix`, function () {
    var xre, dlmtr, content
    let test = (s, prefix, content) => {
...
describe(`Inline tests at core/xre/xre.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
  it(`identifier_annotated_valued`, function () {
...
describe(`Inline tests at core/xre/xre.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
  it(`function_builtin_before`, function () {
...
describe(`Inline tests at core/xre/xre.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
  it(`function_builtin_after`, function () {
...
describe(`Inline tests at core/xre/xre.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
  it(`function_stored_after`, function () {
...
describe(`Inline tests at core/xre/xre.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
  it(`function_overriden`, function () {
