// This file was generated by "prepare.py" on 2020-09-10 16:16:45.108322

describe(`Inline tests at core/o4t/o4t.js`, function () {
  this.timeout(20000)
...
//     */
//    c9rPrepare ($this, ...$) {
  it(`eYo.o4t.c9rPrepare`, function () {
...
//       */
//      [p6y$.shortcuts] () {
    describe(`p6y$.shortcuts`, function () {
//        let _p = this.C9r_p
...
//      this[this.p6y$.shortcuts]()
    it(`p6y$.merge+shortcuts`, function () {
      let ns = eYo.c9r.newNS()
      let C9r = ns.makeC9rBase(true)
      let eyo = C9r[eYo.$]
      eyo.p6yEnhanced()
...
//        [p6y$.ownedValueForEach] ($this, f) {
      it(`p6y$.ownedValueForEach`, function () {
...
//        [p6y$.ownedValueSome] ($this, f) {
      it(`p6y$.ownedValueSome`, function () {
...
//  
//  eYo.mixinFR(eYo.o4t._p, {
  describe(`eYo.o4t extension`, function () {
//    /**
