 ...
 */
eYo.o4t._p.prepareDlgt_p = function (prototype) {
...
;['owned', 'cloned', 'valued', 'cached', 'computed'].forEach(k => {
  var k_ = k + '_'
  var k__ = k + '__'
  Object.defineProperty(eYo.o4t.Dlgt._p, k_, {
    get () {
      if (this[k__]) {
        return this[k__]
      }
   ...
   */
  var name = k + 'ForEach'
  eYo.C9r.eyo._p[name] = function (f) {
 ...
 */
eYo.o4t.Dlgt._p.modelConsolidate = function (model) {
 ...
 * @param {Object} model - The model contains informations to extend the receiver's associate constructor.
 */
eYo.o4t.Dlgt._p.handleModel = function (model) {
  if (model) {
    var s = this.super
 ...
 */
eYo.o4t.Dlgt._p.preInitInstance = function (object) {
 ...
 */
eYo.o4t.Dlgt._p.initInstance = function (object) {
  if (!object) {
 ...
 * @param {Object} instance -  instance is an instance of a subclass of the `C9r_` of the receiver
 */
eYo.o4t.Dlgt._p.disposeInstance = function (object) {
 ...
 */
eYo.o4t.Dlgt._p.registerInit = function (k, model) {
  if (eYo.isNA(model)) {
    console.error('BREAK HERE!')
  }
 ...
 */
eYo.o4t.Dlgt._p.registerDispose = function (k, model) {
 ...
 */
eYo.o4t.Dlgt._p.modelDeclare = function (model) {
 ...
 * f any.
 */
eYo.o4t.Dlgt._p.CONSTDeclare = function (k, model = {}) {
 ...
 * f any.
 */
eYo.o4t.Dlgt._p.valuedDeclare_ = function (k, model) {
 ...
 */
eYo.o4t.Dlgt._p.consolidatorMake = function (k, model) {
  let C9r = this.C9r_
 ...
 * @param {Array<String>} names names of the link to add
 */
eYo.o4t.Dlgt._p.valuedDeclare = function (model) {
  if (model.forEach) {
    model.forEach(k => {
 ...
 */
eYo.o4t.Dlgt._p.valuedClear_ = function (object) {
 ...
 */
eYo.o4t.Dlgt._p.ownedDeclare_ = function (k, model = {}) {
  eYo.parameterAssert(!this.props__.has(k))
  this.owned_.add(k)
  let _p = this.C9r_p
  var k_ = k + '_'
 ...
 */
eYo.o4t.Dlgt._p.ownedDeclare = function (many) {
  if (many.forEach) {
    many.forEach(k => {
 ...
 */
eYo.o4t.Dlgt._p.ownedDispose_ = function (object, ...params) {
  this.ownedForEach(k => {
    var k_ = k + '_'
    var k__ = k + '__'
    var x = object[k__]
 ...
 */
eYo.o4t.Dlgt._p.cachedDeclare_ = function (k, model) {
  eYo.parameterAssert(!this.props__.has(k))
  this.cached_.add(k)
 ...
 */
eYo.o4t.Dlgt._p.cachedDeclare = function (many) {
 ...
 */
eYo.o4t.Dlgt._p.cachedForget_ = function () {
 ...
 * Forget all the cached valued.
 */
eYo.o4t.Dlgt._p.cachedUpdate_ = function () {
  this.cachedForEach(n => {
 ...
 */
eYo.o4t.Dlgt._p.computedDeclare = function (models) {
 ...
 * @param {Map<String, Function>} models,  the key => Function mapping.
 */
eYo.o4t.Dlgt._p.calledDeclare = function (model) {
  let p = this.C9r_p
  Object.keys(model).forEach(k => {
 ...
 */
eYo.o4t.Dlgt._p.clonedDeclare = function (models) {
  this.init_ || (this.init_ = Object.create(null))
  var proto = this.C9r_.prototype
 ...
 */
eYo.o4t.Dlgt._p.clonedDispose_ = function (object) {
 ...
 */
eYo.o4t.Dlgt._p.makeInitUI = function () {
 ...
 */
eYo.o4t.Dlgt._p.makeDisposeUI = function () {
  var ui = this.model.ui
