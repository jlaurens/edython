...
/**
 * @name {eYo.changer.BaseC3s}
 * @constructor
 * @param{Object} owner
 */
eYo.changer.makeBaseC3s({
//<<< mochai: eYo.changer.BaseC3s
  //<<< mochai: Basics
  //... chai.assert(eYo.changer.BaseC3s)
  //... chai.expect(eYo.changer.BaseC3s).equal(eYo.Changer)
  //>>>
  init () {
    this.reset()
  },
