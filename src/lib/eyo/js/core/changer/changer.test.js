// This file was generated by "update.py" on 2020-09-26 09:37:50.500598
...
describe(`Inline tests at core/changer/changer.js`, function () {
  this.timeout(20000)
...
describe(`Inline tests at core/changer/changer.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
  describe(`eYo.changer.BaseC3s`, function () {
describe(`Inline tests at core/changer/changer.js`, function () {
  this.timeout(20000)
  beforeEach (function () { eYo.test.setup() })
  eYo.test.onrModel = eYo.NA
...
describe(`Inline tests at core/changer/changer.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
    it(`(add|remove)ChangeDoneListener`, function () {
...
describe(`Inline tests at core/changer/changer.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
    it(`wrap+begin/end/done`, function () {
      let onr = eYo.c3s.new({
        methods: {
          onChangeBegin () {
            eYo.flag.push(1)
