 ...
 * `eYo.model.Format`.
 * No subclassing.
 * @param {eYo.model.Format} [parent] - the parent if any, required when a key is given
...
eYo.mixinFR(eYo.model.Format_p, {
  /**
   * Smart getter method.
...
eYo.mixinRO(eYo.model.Format_p, {
  /**
...
eYo.mixinFR(eYo.model.Format_p, {
  ...
  validate (path, model, key) {
    ...
    if (eYo.isDef(model)/* && !(model instanceof eYo.c3s.BaseC3s)*/) {
      // validate the model
      let v = c.validate_
