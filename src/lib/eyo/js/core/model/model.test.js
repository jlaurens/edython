// This file was generated by "update.py" on 2020-09-26 09:37:50.553327
...
//  eYo.require('const')
//  
describe(`Inline tests at core/model/model.js`, function () {
  this.timeout(20000)
  beforeEach (function () { eYo.test.setup() })
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
  describe(`eYo.model`, function () {
//  
//  /**
...
describe(`Inline tests at core/model/model.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
    it(`eYo.model.validateBool`, function () {
...
describe(`Inline tests at core/model/model.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
    it(`eYo.model.validateStr`, function () {
...
describe(`Inline tests at core/model/model.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
    it(`eYo.model.validateF`, function () {
...
describe(`Inline tests at core/model/model.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
    it(`eYo.model.validateForFalse`, function () {
...
describe(`Inline tests at core/model/model.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
    it(`eYo.model.validateForTrue`, function () {
...
describe(`Inline tests at core/model/model.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
    it(`eYo.model.validateRA`, function () {
...
describe(`Inline tests at core/model/model.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
    it(`eYo.model.validateD`, function () {
...
describe(`Inline tests at core/model/model.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
    it(`Yo.model.Format_p.get`, function () {
      var mf = new eYo.model.Format()
      mf.allow('a')
      var mf_a = mf.get('a')
      chai.assert(mf_a)
...
describe(`Inline tests at core/model/model.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
    it(`eYo.model.Format_p.allow`, function () {
//      var c = this
//      $.forEach(arg => {
//        if (arg) {
...
describe(`Inline tests at core/model/model.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
    it(`eYo.model.Format_p.(all|path)`, function () {
      var mf = new eYo.model.Format()
...
describe(`Inline tests at core/model/model.js`, function () {
  ...
  eYo.test.onrModel = eYo.NA
  eYo.test.setup()
    it(`eYo.model.Format_p.validate`, function () {
//      var c = this
//      if (eYo.isStr(path)) {
