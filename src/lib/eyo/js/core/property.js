 ...
 */
eYo.Property.declare = (object, k, data) => {
  data = data || {}
  var k_  = k + '_'
  var k__ = k + '__'
  Object.defineProperty(
    object,
    k__,
    {value: data.value || eYo.NA, writable: true}
  )
  Object.defineProperty(
    object,
    k_,
 ...
 * @param {Object} many,  the K => V mapping to which we apply `eYo.Property.declare(proto, K, V)`.
 */
eYo.Property.addMany = (proto, many) => {
  Object.keys(many).forEach(n => {
    eYo.Property.declare(proto, n, many[n])
  })
}
...
eYo.Property.addCached = (proto, key, data) => {
  var getter = (key) => {
    return function () {
      var k = key + '__'
      var v = this[k]
      return v !== eYo.NA ? v : (this[k] = data.get.call(this))
    }
  }
  Object.defineProperty(
    proto,
    key+'__',
    {value: eYo.NA, writable: true}
  )
  Object.defineProperty(
    proto,
    key,
