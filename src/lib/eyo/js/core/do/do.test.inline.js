// This file was generated by "prepare.py" on 2020-09-10 16:16:45.024534

describe(`Inline tests at core/do/do.js`, function () {
  this.timeout(20000)
...
//    end_finally_f
//  ) => {
  describe(`makeWrapper_`, function () {
...
//  ) => {
  describe(`makeWrapper`, function () {
    ...
    it(`end_finally_f / 4 arguments`, function () {
//    // $this|NA, start_f|NA, begin_finally_f|NA, end_finally_f
    ...
    it(`other possibilities`, function () {
//    // possible arguments:
