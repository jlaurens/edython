...
eYo.tooltip.TITLE = {
  ...
  power: 'Puissance',
  expression_stmt: 'Instruction à partir d\'un bloc expression, commentaire, les deux',
  ...
  any: 'Expression générale à saisir. Vrai si l\'un des éléments d\'une liste, un ensemble, un tuple, est vrai',
