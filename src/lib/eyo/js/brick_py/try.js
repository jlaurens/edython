 ...
 * For edython.
 */
eYo.stmt.group[eYo.$newSubC3s]('try_part', true, {
  fields: {
    prefix: 'try'
  }
})
 ...
 * For edython.
 */
eYo.stmt.group[eYo.$newSubC3s]('except_part', true, {
  data: {
    variant: {
      all: [
        eYo.key.NONE,
 ...
 * For edython.
 */
eYo.stmt.newC3s('raise_stmt', true, {
  data: {
    variant: {
      all: [
        eYo.key.NONE,
 ...
 * For edython.
 */
eYo.stmt.newC3s('assert_stmt', true, {
  data: {
    variant: {
      all: [
        eYo.key.UNARY,
