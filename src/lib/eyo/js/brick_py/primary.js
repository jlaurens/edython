 ...
 */
eYo.consolidator.List.makeInheritedC9r('Target', {
  list: {
    check: null,
    mandatory: 1,
    presep: ',',
 ...
 * @param {eYo.magnet.Base} oldTargetM4t that was connected to blockConnection
 */
 ...
 * @param {eYo.brick.Base} brick to be initialized.
