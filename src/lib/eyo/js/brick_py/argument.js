 ...
 */
eYo.consolidator.List[eYo.$newSubC3s]('Arguments', {
  list: {
    check: null,
    mandatory: 0,
    presep: ',',
...
eYo.consolidator.Arguments.prototype.doCleanup = (() => {
  ...
  return function (io) {
    eYo.consolidator.Arguments[eYo.$].C3s_s.doCleanup.call(this, io)
 ...
 * For edython.
 */
eYo.expr.List[eYo.$newSubC3s]('argument_list', {
  data: {
    ary: {
      order: 200,
      init: Infinity,
 ...
 * For edython.
 */
eYo.expr.argument_list[eYo.$newSubC3s]('argument_list_comprehensive', {
  list: {
