 ...
 */
eYo.consolidator.List[eYo.$newSubC9r]('Arguments', {
  list: {
    check: null,
    mandatory: 0,
    presep: ',',
 ...
 * For edython.
 */
eYo.expr.List[eYo.$newSubC9r]('argument_list', {
  data: {
    ary: {
      order: 200,
      init: Infinity,
 ...
 * For edython.
 */
eYo.expr.argument_list[eYo.$newSubC9r]('argument_list_comprehensive', {
  list: {
