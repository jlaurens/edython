describe('YIELD expression and statement', function() {
  it(`Basic yield statement`, function() {
    var d = eYo.Test.new_brick(eYo.ns.T3.Stmt.yield_stmt)
    eYo.Test.code(d, 'yield')
    eYo.Test.brick(d, 'yield_stmt')
    d.dispose()
  })
  it(`Basic yield expression`, function() {
    var d = eYo.Test.new_brick(eYo.ns.T3.Expr.yield_expr)
    eYo.Test.code(d, 'yield')
  ...
  it(`yield <abc>`, function() {
    ...
    t9k.connectLast(eYo.Test.new_brick(eYo.ns.T3.Expr.identifier)).target_p = 'abc'
    eYo.Test.code(d, 'yield abc')
    eYo.Test.input_length(d.expression_b, 3)
    t9k.connectLast(eYo.Test.new_brick(eYo.ns.T3.Expr.identifier)).target_p = 'bcd'
  ...
  it(`yield abc -> yield <abc> -> yield abc`, function() {
    var d = eYo.ns.Brick.newReady(eYo.app.board, eYo.ns.T3.Stmt.yield_stmt)
    d.expression_p = 'abc'
    eYo.Test.code(d, 'yield abc')
    var t9k = d.expression_b
    t9k.connectLast(eYo.Test.new_brick(eYo.ns.T3.Expr.identifier)).target_p = 'bcd'
  ...
  it(`yield from <bcd>`, function() {
    var d = eYo.Test.new_brick(eYo.ns.T3.Stmt.yield_stmt)
    d.from_s.connect(eYo.Test.new_brick(eYo.ns.T3.Expr.identifier)).brick.target_p = 'bcd'
