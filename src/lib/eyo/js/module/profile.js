 ...
 * @param {*} identifier
 */
eYo.module.BaseC3s_p.getProfile = function(identifier) {
  ...
  if (item) {
    ans = new eYo.t3.profile.BaseC3s(this, {
...
eYo.mixinRO(eYo.t3.profile, {
  ...
  void: new eYo.t3.profile.BaseC3s(null, {
    isVoid: true
  }),
  /* Profile for an unset identifier */
  unset: new eYo.t3.profile.BaseC3s(null, {
    expr: eYo.t3.expr.identifier,
    isUnset: true
  }),
  /* Profile for an integer */
  integer: new eYo.t3.profile.BaseC3s(null, {
    expr: eYo.t3.expr.integer
  }),
  /* Profile for a float number */
  floatnumber: new eYo.t3.profile.BaseC3s(null, {
...
eYo.t3.profile.getDotted = function (candidate, module) {
  ...
  if (m) {
    ...
    return new eYo.t3.profile.BaseC3s(null, {
      raw: m.dots
...
eYo.t3.profile.getReserved = function (identifier) {
  ...
  if ((out = {
    ...
    return new eYo.t3.profile.BaseC3s(null, out)
  }
  if ((out = {
