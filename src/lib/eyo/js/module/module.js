...
/**
 * Item constuctor.
 * This must not inherit from `eYo.module.BaseC3s` but from `eYo.o4t.BaseC3s`. 
 ...
 */
eYo.module.BaseC3s_p.getItem = function (key) {
  if (!eYo.isNum(key)) {
 ...
 */
eYo.module.BaseC3s_p.getItemsInCategory = function (category, type) {
 ...
 * @param {String} key  The name of the category
 */
eYo.module.BaseC3s_p.forEachItemWithType = function (type, handler) {
  if (eYo.isStr(type)) {
