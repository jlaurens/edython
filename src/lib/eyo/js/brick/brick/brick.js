  ...
  methods: {
    ...
    */
    ...
    connectEffect () {
      ...
      this.driver.do_connectEffect(this)
    },
    /**
     * The default implementation forwards to the driver.
    ...
    disposeEffect () {
      ...
      this.driver.do_disposeEffect(this)
    },
    /**
     * The default implementation forwards to the driver.
     * This must take place while the brick is still in a consistent state.
 ...
 */
eYo.driver.makeForwarder(eYo.Brick_p, 'updateShape')
 ...
 * The default implementation forwards to the driver.
 */
eYo.driver.makeForwarder(eYo.Brick_p, 'updateWrapped')
 ...
 */
eYo.driver.makeForwarder(eYo.Brick_p, 'moveTo')
 ...
 */
eYo.driver.makeForwarder(eYo.Brick_p, 'moveBy')
