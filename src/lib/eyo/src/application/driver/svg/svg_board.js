 ...
 */
eYo.Dom.Board.prototype.initUI = eYo.Dom.decorateInit(function(board) {
  /*
 ...
 * @param {!eYo.Board} board
 */
eYo.Dom.Board.prototype.disposeUI = eYo.Dom.decorateDispose(function(board) {
 ...
 */
eYo.Svg.Board.prototype.initUI = function(board) {
  var dom = board.dom
  if (dom) {
    return
  }
  ...
  */
  ...
  // el.style.fill = 'blue'
  if (!board.readOnly) {
    this.bind_mousedown(board)
    if (options.zoom && options.zoom.wheel) {
      this.bind_wheel(board)
    }
  }
 ...
 * @param {!eYo.Board} board
 */
eYo.Svg.Board.prototype.disposeUI = eYo.Dom.decorateDispose(function(board) {
  var dom = board.dom
  var svg = dom.svg
 ...
 * @param {!eYo.Board} board
 */
eYo.Svg.Board.prototype.place = function(board) {
  var dom = board.dom
 ...
 * @param {!eYo.Board} board
 */
eYo.Svg.Board.prototype.didScale = function(board) {
 ...
 */
eYo.Svg.Board.prototype.visibleGet = function (board) {
 ...
 * @param {!String} mode  The display mode for bricks.
 */
eYo.Svg.Board.prototype.visibleSet = function (board, isVisible) {
 ...
 * @param {!eYo.Board} board
 */
eYo.Svg.Board.prototype.bind_mousedown = function(board) {
  var dom = board.dom
  var bound = dom.bound
  if (bound.mousedown) {
    return
 ...
 * @private
 */
eYo.Svg.Board.prototype.on_mousedown = function(board, e) {
 ...
 * @param {!eYo.Board} board
 */
eYo.Svg.Board.prototype.bind_wheel = function(board) {
 ...
 * @private
 */
eYo.Svg.Board.prototype.on_wheel = function(board, e) {
 ...
 * @private
 */
eYo.Svg.Board.prototype.setBrowserFocus = function(board) {
 ...
 */
eYo.Svg.Board.prototype.eventWhere = function(board, e) {
 ...
 */
eYo.Svg.Board.prototype.zoom = function(board, xy, scaleChange) {
  if (board.scrollbar) {
    var svg = board.dom.svg
 ...
 * @private
 */
eYo.Svg.Board.prototype.elementWhere = function(board, element) {
