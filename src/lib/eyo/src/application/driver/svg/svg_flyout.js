 ...
 */
eYo.Dom.Flyout.prototype.initUI = eYo.Dom.decorateInit(function(flyout) {
  var dom = flyout.dom
 ...
 * @param {eYo.Flyout} flyout
 */
eYo.Dom.Flyout.prototype.disposeUI = eYo.Dom.decorateDispose(function (flyout) {
  var dom = flyout.dom
 ...
 * @param {!eYo.Flyout} flyout
 */
eYo.Svg.Flyout.prototype.disposeUI = eYo.Dom.decorateDispose(function (flyout) {
  var dom = flyout.dom
 ...
 * @param {!eYo.FlyoutToolbar} flyoutToolbar
 */
eYo.Svg.Flyout.prototype.toolbarDisposeUI = eYo.Dom.decorateDispose(function(ftb) {
  var dom = ftb.dom
  var div = dom.div_
  var fc
