 ...
 */
eYo.Svg.Scrollbar.prototype.initUI = eYo.Dom.decorateInit(function(scrollbar, opt_class) {
 ...
 * @param {!eYo.Scrollbar} scrollbar
 */
eYo.Svg.Scrollbar.prototype.disposeUI = eYo.Dom.decorateDispose(function (scrollbar) {
  var dom = scrollbar.dom
