...
describe('Assignment', function() {
  ...
  it('Expression only', function() {
    ...
    chai.assert(d1.value_t.connectLast(d2), 'MISSED C8N 1')
...
describe('Copy/Paste', function() {
  ...
  it ('identifier_annotated in name', function () {
    ...
    chai.assert(d1.target_t.connectLast(d2), `MISSED C8N 1`)
...
describe('One block: annotated_assignment_stmt', function() {
  it ('target is annotated', function () {
    eYo.Test.setItUp()
    var d_main = eYo.Test.new_dlgt('assignment_stmt')
    ...
    eYo.Test.dlgt(d_main, 'annotated_assignment_stmt')
    annotated.block_.dispose()
    eYo.Test.dlgt(d_main, 'assignment_stmt')
    d_main.block_.dispose()
    eYo.Test.tearItDown()
  })
  it('target', function() {
    eYo.Test.setItUp()
    var d_main = eYo.Test.new_dlgt('annotated_assignment_stmt')
    ...
    eYo.Test.input_length(d_main.target_b, 1, `MISSED C8N 1`)
    ...
    chai.assert(d_main.annotated_b === d3, 'MISSED C8N')
    ...
    chai.assert(d_main.target_b.inputList[0].eyo.connect(d3), 'MISSED C8N 4')
    eYo.Test.dlgt(d_main, 'annotated_assignment_stmt')
    eYo.Test.input_length(d_main.target_b, 1, `MISSED C8N 5`)
