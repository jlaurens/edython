...
make_fake('ezp_expr_fake_starred_or_expr','starred_or_expr',ezP.T3.starred_or_expr)
...
make_fake('ezp_expr_fake_starred_expression','*expression',ezP.T3.starred_expression)
make_fake('ezp_expr_fake_keyword_item','key = value',ezP.T3.keyword_item)
make_fake('ezp_expr_fake_double_starred_expression','**expression',ezP.T3.double_starred_expression)
