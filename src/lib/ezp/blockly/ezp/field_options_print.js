...
ezP.FieldPrintOptions = function (menuGenerator, optValidator) {
  this.ezpState = {}
  ezP.FieldPrintOptions.superClass_.constructor.call(this, menuGenerator, optValidator)
...
ezP.FieldPrintOptions.prototype.init = function () {
  ...
  this.imageElement_ = ezP.Style.MenuIcon.path(this.fieldGroup_)
...
ezP.FieldPrintOptions.prototype.createMenu_ = function () {
  ...
  renderer = ezP.KeyValueMenuItemRenderer.getInstance()
...
ezP.FieldPrintOptions.prototype.getState_ = function () {
  ...
  ezp = this.sourceBlock_ ? this.sourceBlock_.ezp : null
