// This file was generated by "python types.py" on 2018-02-09 18:38:50.544977
...
// core expressions
  ...
  module_name               /*   ::= the uasge name of a module                         */ : "ezp_module_name",
  from_relative_module_import /*   ::= "from" relative_module "import" non_void_import_identifier_named_list */ : "ezp_from_relative_module_import",
  parent_module             /*   ::= '.' [relative_module]                              */ : "ezp_parent_module",
  import_identifier_named   /*   ::= import_identifier "as" import_name                 */ : "ezp_import_identifier_named",
  import_identifier         /*   ::= an identifier but not a variable name              */ : "ezp_import_identifier",
...
// lists
  ...
  non_void_import_identifier_named_list /*   ::= import_identifier_named ( "," import_identifier_named )* */ : "ezp_non_void_import_identifier_named_list",
...
ezP.T3.Expr.Check = {
  ...
  non_void_import_identifier_named_list: [
    ezP.T3.Expr.import_identifier_named,
  ],
  identifier_list: [
    ezP.T3.Expr.identifier,
  ],
