// This file was generated by "python types.py" on 2018-02-03 22:01:33.995424
...
// part statements
  ...
  classdef_part             /*   ::= "class" classname [inheritance] ":"                */ : "ezp_classdef_part",
// other simple statements
  ...
  decorator                 /*   ::= "@" dotted_name ["(" [argument_list [","]] ")"] NEWLINE */ : "ezp_decorator",
...
// compound statements
  ...
  funcdef                   /*   ::= [decorators] "def" funcname "(" [parameter_list] ")" ["->" expression] ":" suite */ : "ezp_funcdef",
...
// core expressions
  ...
  identifier_dotted_list    /*   ::=                                                    */ : "ezp_identifier_dotted_list",
  imagnumber                /*   ::=                                                    */ : "ezp_imagnumber",
  floatnumber               /*   ::=                                                    */ : "ezp_floatnumber",
  integer                   /*   ::=                                                    */ : "ezp_integer",
  bytesliteral              /*   ::=                                                    */ : "ezp_bytesliteral",
  stringliteral             /*   ::=                                                    */ : "ezp_stringliteral",
  identifier_void_list      /*   ::=                                                    */ : "ezp_identifier_void_list",
  identifier                /*   ::=                                                    */ : "ezp_identifier",
  ...
  call                      /*   ::= primary "(" [argument_list [","] | comprehension] ")" */ : "ezp_call",
  argument_list             /*   ::= REMOVE                                             */ : "ezp_argument_list",
  positional_arguments      /*   ::= REMOVE                                             */ : "ezp_positional_arguments",
  ...
  identifier_dotted         /*   ::= "." identifier                                     */ : "ezp_identifier_dotted",
  ...
  augop                     /*   ::= "+=" | "-=" | "*=" | "@=" | "/=" | "//=" | "%=" | "**=" | ">>=" | "<<=" | "&=" | "^=" | "|=" */ : "ezp_augop",
  relative_module           /*   ::= "."* module | "."+                                 */ : "ezp_relative_module",
  ...
  from_relative_module_import /*   ::= "from" relative_module "import" identifier_named_list */ : "ezp_from_relative_module_import",
  import_module             /*   ::= "import" identifier_named_list                     */ : "ezp_import_module",
  module_named_list         /*   ::= module_named "," ... "," module_named              */ : "ezp_module_named_list",
  module_named_concrete     /*   ::= module "as" name                                   */ : "ezp_module_named_concrete",
  identifier_named          /*   ::= identifier "as" name                               */ : "ezp_identifier_named",
  with_item_concrete        /*   ::= expression "as" target                             */ : "ezp_with_item_concrete",
  parameter_list            /*   ::= REMOVE                                             */ : "ezp_parameter_list",
...
// lists
  ...
  identifier_named_list     /*   ::= identifier_named ( "," identifier_named )*         */ : "ezp_identifier_named_list",
...
// wrappers, like starred_item ::=  expression | star_expr
  ...
  literal                   /*   ::= stringliteral | bytesliteral | integer | floatnumber | imagnumber */ : "ezp_literal",
  ...
  import                    /*   ::= import_module | from_relative_module_import | from_module_import */ : "ezp_import",
...
ezP.T3.Expr.starred_list = ezP.T3.Expr.non_void_starred_item_list
ezP.T3.Expr.starred_expression = ezP.T3.Expr.starred_item_list
ezP.T3.Expr.starred_list_comprehensive = ezP.T3.Expr.non_void_starred_item_list_comprehensive
ezP.T3.Expr.module = ezP.T3.Expr.identifier_dotted_list
ezP.T3.Expr.feature = ezP.T3.Expr.identifier
ezP.T3.Expr.module_void = ezP.T3.Expr.identifier_void_list
...
ezP.T3.Expr.Check = {
  ...
  module_named: [
    ezP.T3.Expr.identifier_dotted_list,
...
ezP.T3.Expr.Check.starred_list = ezP.T3.Expr.Check.non_void_starred_item_list
ezP.T3.Expr.Check.starred_expression = ezP.T3.Expr.Check.starred_item_list
ezP.T3.Expr.Check.starred_list_comprehensive = ezP.T3.Expr.Check.non_void_starred_item_list_comprehensive
ezP.T3.Expr.Check.module = ezP.T3.Expr.Check.identifier_dotted_list
ezP.T3.Expr.Check.feature = ezP.T3.Expr.Check.identifier
ezP.T3.Expr.Check.module_void = ezP.T3.Expr.Check.identifier_void_list
