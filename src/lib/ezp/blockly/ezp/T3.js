// This file was generated by "python types.py" on 2018-02-12 18:41:12.210432
...
// other simple statements
  simple_stmt               /*   ::= expression_stmt | assert_stmt | assignment_stmt | augmented_assignment_stmt | annotated_assignment_stmt | pass_stmt | del_stmt | return_stmt | yield_stmt | raise_stmt | break_stmt | continue_stmt | import_part | global_stmt | nonlocal_stmt */ : "ezp_simple_stmt",
  ...
  import_part               /*   ::= "import" module ["as" name] ( "," module ["as" name] )* | "from" relative_module "import" identifier ["as" name] ( "," identifier ["as" name] )* | "from" relative_module "import" "(" identifier ["as" name] ( "," identifier ["as" name] )* [","] ")" | "from" module "import" "*" */ : "ezp_import_part",
...
// core expressions
  ...
  module_identifier         /*   ::=                                                    */ : "ezp_module_identifier",
  attribute_identifier      /*   ::=                                                    */ : "ezp_attribute_identifier",
  ...
  augop                     /*   ::= "+=" | "-=" | "*=" | "@=" | "/=" | "//=" | "%=" | "**=" | ">>=" | "<<=" | "&=" | "^=" | "|=" */ : "ezp_augop",
  module_concrete           /*   ::= module_name '.' module                             */ : "ezp_module_concrete",
  ...
  import_module             /*   ::= "import" non_void_module_as_list                   */ : "ezp_import_module",
  module_as_concrete        /*   ::= module "as" module_alias                           */ : "ezp_module_as_concrete",
  alias                     /*   ::= some alias                                         */ : "ezp_alias",
  from_relative_module_import /*   ::= "from" relative_module "import" non_void_import_identifier_as_list */ : "ezp_from_relative_module_import",
  parent_module             /*   ::= '.' [relative_module]                              */ : "ezp_parent_module",
  import_identifier_as_concrete /*   ::= import_identifier "as" import_alias                */ : "ezp_import_identifier_as_concrete",
...
// lists
  ...
  non_void_module_as_list   /*   ::= module_as ( "," module_as )*                       */ : "ezp_non_void_module_as_list",
  non_void_import_identifier_as_list /*   ::= import_identifier_as ( "," import_identifier_as )* */ : "ezp_non_void_import_identifier_as_list",
...
// wrappers, like starred_item ::=  expression | star_expr
  ...
  not_a_variable            /*   ::= attribute_identifier | module | module_as | module_identifier | module_alias | import_identifier | import_alias | relative_module | import_identifier_as */ : "ezp_not_a_variable",
  ...
  module_as                 /*   ::= module | module_as_concrete                        */ : "ezp_module_as",
  module_alias              /*   ::= identifier                                         */ : "ezp_module_alias",
  import_identifier_as      /*   ::= import_identifier | import_identifier_as_concrete  */ : "ezp_import_identifier_as",
  import_identifier         /*   ::= identifier                                         */ : "ezp_import_identifier",
  import_alias              /*   ::= identifier                                         */ : "ezp_import_alias",
