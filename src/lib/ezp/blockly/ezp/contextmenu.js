...
goog.provide('ezP.ContextMenu')

goog.require('ezP.PopupMenu')
goog.require('ezP.MenuItem')

/**
 * A basic popup menu class for ezPython blocks.
 ...
 * @constructor
 */
ezP.ContextMenu = function (block, optDomHelper, optRenderer) {
 ...
 * Init the menu.
 */
ezP.ContextMenu.prototype.init = function (block) {
  var ezp = this.ezp = {}
