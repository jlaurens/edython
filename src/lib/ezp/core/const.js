...
ezP.RE = {
  ...
  floatnumber: /^(?:(([0-9]*\.[0-9]+)|([0-9]+\.))|((([0-9]+)|(([0-9]*\.[0-9]+)|([0-9]+\.)))[eE]([+-]?[0-9]+)))$/, // beware of capturing groups
  imagnumber: /^(?:(((([0-9]*\.[0-9]+)|([0-9]+\.))|((([0-9]+)|(([0-9]*\.[0-9]+)|([0-9]+\.)))[eE]([+-]?[0-9]+)))|([0-9]+))[jJ])$/, // beware of capturing groups
