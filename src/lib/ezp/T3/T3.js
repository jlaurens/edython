// This file was generated by "python types.py" on 2018-03-30 14:24:54.665416
...
// part statements
  ...
  last_else_part            /*   ::= else_part                                          (default) */ : "ezp_last_else_part",
  ...
  try_else_part             /*   ::= else_part                                          (default) */ : "ezp_try_else_part",
...
// other simple statements
  ...
  raise_stmt                /*   ::= "raise" raise_expression                           (default) */ : "ezp_raise_stmt",
  ...
  docstring_top_stmt        /*   ::= longstringliteral+{1}                              (default) */ : "ezp_docstring_top_stmt",
  ...
  reraise_stmt              /*   ::= "raise"                                            (default) */ : "ezp_reraise_stmt",
  decorator_stmt            /*   ::= decorator                                          (default) */ : "ezp_decorator_stmt",
  docstring_def_stmt        /*   ::= longstringliteral +{1}                             (default) */ : "ezp_docstring_def_stmt",
  print_stmt                /*   ::= print                                              (default) */ : "ezp_print_stmt",
  input_stmt                /*   ::= input                                              (default) */ : "ezp_input_stmt",
// compound statements
}
...
// core expressions
  ...
  shortstringliteral        /*   ::= ''                                                 (default) */ : "ezp_shortstringliteral",
  shortbytesliteral         /*   ::= b''                                                (default) */ : "ezp_shortbytesliteral",
  longstringliteral         /*   ::= ''''''                                             (default) */ : "ezp_longstringliteral",
  longbytesliteral          /*   ::= b''''''                                            (default) */ : "ezp_longbytesliteral",
  integer                   /*   ::= 123                                                (default) */ : "ezp_integer",
  floatnumber               /*   ::= 123.                                               (default) */ : "ezp_floatnumber",
  imagnumber                /*   ::= 123j                                               (default) */ : "ezp_imagnumber",
...
// wrappers, like starred_item ::=  expression | star_expr
  ...
  literal                   /*   ::= shortliteral | longliteral | numberliteral         (default) */ : "ezp_literal",
  ...
  shortliteral              /*   ::= shortstringliteral | shortbytesliteral             (default) */ : "ezp_shortliteral",
  longliteral               /*   ::= longstringliteral | longbytesliteral               (default) */ : "ezp_longliteral",
  bytesliteral              /*   ::= shortbytesliteral | longbytesliteral               (default) */ : "ezp_bytesliteral",
  stringliteral             /*   ::= shortbytesliteral | longbytesliteral               (default) */ : "ezp_stringliteral",
  numberliteral             /*   ::= integer | floatnumber | imagnumber                 (default) */ : "ezp_numberliteral",
