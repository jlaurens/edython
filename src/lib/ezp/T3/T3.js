// This file was generated by "python types.py" on 2018-04-11 12:13:06.992688
...
// part statements
  ...
  funcdef_part              /*   ::= ["async"] "def" funcname "(" [parameter_list] ")" ["->" expression] ":" SUITE (default) */ : "ezp:funcdef_part",
  classdef_part             /*   ::= "class" classname ['(' argument_list ')'] ':'      (default) */ : "ezp:classdef_part",
// other simple statements
  ...
  import_stmt               /*   ::= import_module | from_relative_module_import | from_module_import (default) */ : "ezp:import_stmt",
  ...
  any_stmt                  /*   ::= any statement                                      (default) */ : "ezp:any_stmt",
  call_stmt                 /*   ::= call_expr                                          (default) */ : "ezp:call_stmt",
  builtin_print_stmt        /*   ::= builtin_print_expr                                 (default) */ : "ezp:builtin_print_stmt",
  builtin_call_stmt         /*   ::= builtin_call_expr                                  (default) */ : "ezp:builtin_call_stmt",
  builtin_input_stmt        /*   ::= builtin_input_expr                                 (default) */ : "ezp:builtin_input_stmt",
// compound statements
}
...
// core expressions
  ...
  builtin_print_expr        /*   ::= "print(" argument_list ")"                         (default) */ : "ezp:builtin_print_expr",
  builtin_call_expr         /*   ::= "whatever(" argument_list ")"                      (default) */ : "ezp:builtin_call_expr",
  builtin_input_expr        /*   ::= "input(" [any_argument] ")"                        (default) */ : "ezp:builtin_input_expr",
// lists
