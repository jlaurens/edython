 ...
 */
edY.replaceRuleProperty = function (selectorText, propertyName, value, priority) {
...
if (Object.setPrototypeOf) {
  goog.provide('edY.setPrototypeOf')
}
goog.require('edY.setPrototypeOf')

/**
 * Contrary to goog.inherits, does not erase the childC9r.prototype.
 * IE<11
 */
edY.inherits = function (childC9r, parentC9r) {
