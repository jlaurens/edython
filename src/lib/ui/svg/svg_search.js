 ...
 * @override
 */
eYo.Dom.prototype.searchCssClass = function() {
 ...
 */
eYo.Dom.prototype.searchInit = eYo.Dom.decorateInit(function(search) {
  var dom = search.dom
  ...
  var cssClass = this.searchCssClass()
  var f = (type) => {
 ...
 * @param {eYo.Search} search
 */
eYo.Dom.prototype.searchDispose = eYo.Dom.decorateDispose(function (search) {
  var dom = search.dom
 ...
 * @param {eYo.Search} search
 */
eYo.Dom.prototype.searchUpdateMetrics = function (search) {
 ...
 * @param {!eYo.Search} search
 */
eYo.Svg.prototype.searchInit = function(search) {
  if (search.dom) {
    return
  }
 ...
 * @param {!eYo.Search} search
 */
eYo.Svg.prototype.searchDispose = eYo.Dom.decorateDispose(function (search) {
  var dom = search.dom
 ...
 * @param {Boolean} show
 */
eYo.Svg.prototype.searchDisplaySet = function (search, show) {
 ...
 * @param {!eYo.Search} search
 */
eYo.Svg.prototype.searchDisplayGet = function (search) {
 ...
 */
eYo.Svg.prototype.searchToolbarInit = function(ftb) {
  if (ftb.dom) {
    return
  }
 ...
 * @param {!eYo.SearchToolbar} searchToolbar
 */
eYo.Svg.prototype.searchToolbarDispose = eYo.Dom.decorateDispose(function(ftb) {
  var dom = ftb.dom
  var div = dom.div_
  var fc
 ...
 * @param {!eYo.Search} search
 */
eYo.Svg.prototype.searchPlace = function (search) {
 ...
 * @private
 */
eYo.Svg.prototype.searchUpdate = function(search) {
 ...
 * @param {!eYo.Search} search
 */
eYo.Svg.prototype.searchRemoveAllBrickListeners = function(search) {
 ...
 */
eYo.Svg.prototype.searchAddListeners = function(search, brick) {
 ...
 * @param {!eYo.Search} search
 */
eYo.Svg.prototype.searchListen_mouseover = function(search) {
 ...
 * @param {!eYo.Search} search
 */
eYo.Svg.prototype.searchBindScrollEvents = function(search) {
 ...
 * @private
 */
eYo.Svg.prototype.searchOn_mousedown = function(e) {
