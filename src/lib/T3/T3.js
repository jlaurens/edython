// This file was generated by "python types.py" on 2018-09-15 21:10:16.107117
...
// other simple statements
  ...
  base_call_stmt           : /*   ::= call_expr                                          (Coroutines) */ "eyo:base_call_stmt",
  module__call_stmt        : /*   ::= module__call_expr                                  (Coroutines) */ "eyo:module__call_stmt",
  builtin__print_stmt      : /*   ::= builtin__print_expr                                (Coroutines) */ "eyo:builtin__print_stmt",
  random__import_stmt      : /*   ::= "import random"                                    (Coroutines) */ "eyo:random__import_stmt",
  random__call_stmt        : /*   ::= random__call_expr                                  (Coroutines) */ "eyo:random__call_stmt",
  math__import_stmt        : /*   ::= "import math"                                      (Coroutines) */ "eyo:math__import_stmt",
  math__call_stmt          : /*   ::= math__call_expr                                    (Coroutines) */ "eyo:math__call_stmt",
  turtle__import_stmt      : /*   ::= "import turtle"                                    (Coroutines) */ "eyo:turtle__import_stmt",
  turtle__call_stmt        : /*   ::= turtle__call_expr                                  (Coroutines) */ "eyo:turtle__call_stmt",
  turtle__config_stmt      : /*   ::= turtle.setConfig(...)                              (Coroutines) */ "eyo:turtle__config_stmt",
  turtle__setup_stmt       : /*   ::= "edython.setupTurtle()"                            (Coroutines) */ "eyo:turtle__setup_stmt",
  cmath__import_stmt       : /*   ::= "import cmath"                                     (Coroutines) */ "eyo:cmath__import_stmt",
  cmath__call_stmt         : /*   ::= cmath__call_expr                                   (Coroutines) */ "eyo:cmath__call_stmt",
// compound statements
}
...
// core expressions
  ...
  module__call_expr         : /*   ::= "module".foo (args)                                (Coroutines) */ "eyo:module__call_expr",
  builtin__print_expr       : /*   ::= "print(" argument_list ")"                         (Coroutines) */ "eyo:builtin__print_expr",
  print_argument_list_comprehensive : /*   ::= subclass of argument_list_comprehensive            (Coroutines) */ "eyo:print_argument_list_comprehensive",
  random__call_expr         : /*   ::= random."name" (...)                                (Coroutines) */ "eyo:random__call_expr",
  random__randrange         : /*   ::= "random.randrange"                                 (Coroutines) */ "eyo:random__randrange",
  math__call_expr           : /*   ::= math."name" (...)                                  (Coroutines) */ "eyo:math__call_expr",
  math__const               : /*   ::= math."name"                                        (Coroutines) */ "eyo:math__const",
  turtle__call_expr         : /*   ::= turtle."name" (...)                                (Coroutines) */ "eyo:turtle__call_expr",
  cmath__call_expr          : /*   ::= cmath."name" (...)                                 (Coroutines) */ "eyo:cmath__call_expr",
  cmath__const              : /*   ::= cmath."name"                                       (Coroutines) */ "eyo:cmath__const",
// lists
...
// wrappers, like starred_item ::=  expression | star_expr
  ...
  target_unstar             : /*   ::= identifier | identifier_annotated | parenth_target_list | bracket_target_list | attributeref | subscription | slicing | named_attributeref | named_subscription | named_slicing (Assignment statements) */ "eyo:target_unstar",
...
eYo.T3.Expr.Check = {
  ...
  non_void_starred_item_list: [ // count 40
    eYo.T3.Expr.shortformattedliteral,
    eYo.T3.Expr.longformattedliteral,
    eYo.T3.Expr.parenth_form,
    eYo.T3.Expr.list_display,
  ...
  starred_item_list_comprehensive: [ // count 41
    eYo.T3.Expr.shortformattedliteral,
    eYo.T3.Expr.longformattedliteral,
    eYo.T3.Expr.parenth_form,
  ...
  non_void_starred_item_list_comprehensive: [ // count 41
    eYo.T3.Expr.shortformattedliteral,
    eYo.T3.Expr.longformattedliteral,
    eYo.T3.Expr.parenth_form,
    eYo.T3.Expr.comprehension,
...
eYo.T3.Xml.toDom.Stmt = { // count 35
    ...
    random__import_stmt: 'random__import',
    random__call_stmt: 'random__call',
    math__import_stmt: 'math__import',
    math__call_stmt: 'math__call',
    turtle__import_stmt: 'turtle__import',
    turtle__config_stmt: 'turtle__config',
    cmath__import_stmt: 'cmath__import',
    cmath__call_stmt: 'cmath__call',
}

eYo.T3.Xml.toDom.Expr = { // count 15
    longliteral: 'literal',
    ...
    random__call_expr: 'random__call',
    math__call_expr: 'math__call',
    cmath__call_expr: 'cmath__call',
}

eYo.T3.Xml.fromDom = { // count 35
    for: eYo.T3.Stmt.for_part,
    math__import: eYo.T3.Stmt.math__import_stmt,
    random__import: eYo.T3.Stmt.random__import_stmt,
    ...
    cmath__call: [eYo.T3.Stmt.cmath__call_stmt, eYo.T3.Expr.cmath__call_expr],
    ...
    random__call: [eYo.T3.Stmt.random__call_stmt, eYo.T3.Expr.random__call_expr],
    math__call: [eYo.T3.Stmt.math__call_stmt, eYo.T3.Expr.math__call_expr],
