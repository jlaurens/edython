// This file was generated by "python types.py" on 2018-08-01 07:34:31.581880
...
// other simple statements
  ...
  docstring_stmt           : /*   ::= longstringliteral +{1}                             (The import statement) */ "eyo:docstring_stmt",
  ...
  module__call_stmt        : /*   ::= module__call_expr                                  (Atoms) */ "eyo:module__call_stmt",
  builtin__print_stmt      : /*   ::= builtin__print_expr                                (Atoms) */ "eyo:builtin__print_stmt",
  random__import_stmt      : /*   ::= "import random"                                    (Atoms) */ "eyo:random__import_stmt",
  random__call_stmt        : /*   ::= random__call_expr                                  (Atoms) */ "eyo:random__call_stmt",
  math__import_stmt        : /*   ::= "import math"                                      (Atoms) */ "eyo:math__import_stmt",
  math__call_stmt          : /*   ::= math__call_expr                                    (Atoms) */ "eyo:math__call_stmt",
  turtle__import_stmt      : /*   ::= "import turtle"                                    (Atoms) */ "eyo:turtle__import_stmt",
  turtle__call_stmt        : /*   ::= turtle__call_expr                                  (Atoms) */ "eyo:turtle__call_stmt",
  turtle__config_stmt      : /*   ::= turtle.setConfig(...)                              (Atoms) */ "eyo:turtle__config_stmt",
  turtle__setup_stmt       : /*   ::= "edython.setupTurtle()"                            (Atoms) */ "eyo:turtle__setup_stmt",
  cmath__import_stmt       : /*   ::= "import cmath"                                     (Atoms) */ "eyo:cmath__import_stmt",
  cmath__call_stmt         : /*   ::= cmath__call_expr                                   (Atoms) */ "eyo:cmath__call_stmt",
// compound statements
}
...
// core expressions
  ...
  base_call_expr            : /*   ::= "name" "(" argument_list_comprehensive ")"         (Atoms) */ "eyo:base_call_expr",
  module__call_expr         : /*   ::= "module".foo (args)                                (Atoms) */ "eyo:module__call_expr",
  ...
  builtin__print_expr       : /*   ::= "print(" argument_list ")"                         (Atoms) */ "eyo:builtin__print_expr",
  print_argument_list_comprehensive : /*   ::= subclass of argument_list_comprehensive            (Atoms) */ "eyo:print_argument_list_comprehensive",
  builtin__range            : /*   ::= "range(" range_argument_list ")"                   (Atoms) */ "eyo:builtin__range",
  range_argument_list       : /*   ::= 3 elements                                         (Atoms) */ "eyo:range_argument_list",
  builtin__input_expr       : /*   ::= "input(" [any_argument] ")"                        (Atoms) */ "eyo:builtin__input_expr",
  argument_list_2           : /*   ::= 2 arguments at most                                (Atoms) */ "eyo:argument_list_2",
  argument_list_3           : /*   ::= 3 arguments at most                                (Atoms) */ "eyo:argument_list_3",
  argument_list_4           : /*   ::= 4 arguments at most                                (Atoms) */ "eyo:argument_list_4",
  argument_list_5           : /*   ::= 5 arguments at most                                (Atoms) */ "eyo:argument_list_5",
  random__call_expr         : /*   ::= random."name" (...)                                (Atoms) */ "eyo:random__call_expr",
  random__randrange         : /*   ::= "random.randrange"                                 (Atoms) */ "eyo:random__randrange",
  math__call_expr           : /*   ::= math."name" (...)                                  (Atoms) */ "eyo:math__call_expr",
  math__const               : /*   ::= math."name"                                        (Atoms) */ "eyo:math__const",
  turtle__call_expr         : /*   ::= turtle."name" (...)                                (Atoms) */ "eyo:turtle__call_expr",
  cmath__call_expr          : /*   ::= cmath."name" (...)                                 (Atoms) */ "eyo:cmath__call_expr",
  cmath__const              : /*   ::= cmath."name"                                       (Atoms) */ "eyo:cmath__const",
// lists
...
eYo.T3.Xml.toDom.Expr = { // count 18
