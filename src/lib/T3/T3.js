// This file was generated by "python types.py" on 2018-06-23 10:24:55.620133
...
// other simple statements
  ...
  module_call_stmt         : /*   ::= module_call_expr                                   (Coroutines) */ "eyo:module_call_stmt",
  ...
  random__seed_stmt        : /*   ::= "random.seed" (a=None, version=2)                  (Coroutines) */ "eyo:random__seed_stmt",
  random__setstate_stmt    : /*   ::= "random.setstate" (state)                          (Coroutines) */ "eyo:random__setstate_stmt",
  random__shuffle_stmt     : /*   ::= "random.shuffle" (x[, random])                     (Coroutines) */ "eyo:random__shuffle_stmt",
// compound statements
}
...
// core expressions
  ...
  module_call_expr          : /*   ::= module."name" "(" argument_list_comprehensive ")"  (Atoms) */ "eyo:module_call_expr",
  ...
  builtin__range            : /*   ::= "range(" range_argument_list ")"                   (Coroutines) */ "eyo:builtin__range",
  range_argument_list       : /*   ::= 3 elements                                         (Coroutines) */ "eyo:range_argument_list",
  builtin__input_expr       : /*   ::= "input(" [any_argument] ")"                        (Coroutines) */ "eyo:builtin__input_expr",
  argument_list_2           : /*   ::= 2 arguments at most                                (Coroutines) */ "eyo:argument_list_2",
  argument_list_3           : /*   ::= 3 arguments at most                                (Coroutines) */ "eyo:argument_list_3",
  random__call_expr         : /*   ::= random."name" (...)                                (Coroutines) */ "eyo:random__call_expr",
  random__randrange         : /*   ::= "random.randrange" (start, stop[, step])           (Coroutines) */ "eyo:random__randrange",
// lists
