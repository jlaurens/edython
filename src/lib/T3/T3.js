// This file was generated by "python types.py" on 2018-10-22 11:16:24.045849
...
// other simple statements
  ...
  module__call_stmt        : /*   ::= module__call_expr                                  (Expression statements) */ "eyo:module__call_stmt",
  builtin__print_stmt      : /*   ::= builtin__print_expr                                (Expression statements) */ "eyo:builtin__print_stmt",
  random__import_stmt      : /*   ::= "import random"                                    (Expression statements) */ "eyo:random__import_stmt",
  random__call_stmt        : /*   ::= random__call_expr                                  (Expression statements) */ "eyo:random__call_stmt",
  math__import_stmt        : /*   ::= "import math"                                      (Expression statements) */ "eyo:math__import_stmt",
  math__call_stmt          : /*   ::= math__call_expr                                    (Expression statements) */ "eyo:math__call_stmt",
  turtle__import_stmt      : /*   ::= "import turtle"                                    (Expression statements) */ "eyo:turtle__import_stmt",
  turtle__call_stmt        : /*   ::= turtle__call_expr                                  (Expression statements) */ "eyo:turtle__call_stmt",
  turtle__config_stmt      : /*   ::= turtle.setConfig(...)                              (Expression statements) */ "eyo:turtle__config_stmt",
  turtle__setup_stmt       : /*   ::= "edython.setupTurtle()"                            (Expression statements) */ "eyo:turtle__setup_stmt",
  cmath__import_stmt       : /*   ::= "import cmath"                                     (Expression statements) */ "eyo:cmath__import_stmt",
  cmath__call_stmt         : /*   ::= cmath__call_expr                                   (Expression statements) */ "eyo:cmath__call_stmt",
// compound statements
}
...
// core expressions
  ...
  module__call_expr         : /*   ::= "module".foo (args)                                (Expression statements) */ "eyo:module__call_expr",
  ...
  random__call_expr         : /*   ::= random."name" (...)                                (Expression statements) */ "eyo:random__call_expr",
  random__randrange         : /*   ::= "random.randrange"                                 (Expression statements) */ "eyo:random__randrange",
  math__call_expr           : /*   ::= math."name" (...)                                  (Expression statements) */ "eyo:math__call_expr",
  math__const               : /*   ::= math."name"                                        (Expression statements) */ "eyo:math__const",
  turtle__call_expr         : /*   ::= turtle."name" (...)                                (Expression statements) */ "eyo:turtle__call_expr",
  cmath__call_expr          : /*   ::= cmath."name" (...)                                 (Expression statements) */ "eyo:cmath__call_expr",
  cmath__const              : /*   ::= cmath."name"                                       (Expression statements) */ "eyo:cmath__const",
// lists
