// This file was generated by "python types.py" on 2018-09-06 16:20:22.823622
...
// core expressions
  ...
  void_name                 : /*   ::= ""                                                 (default) */ "eyo:void_name",
...
// wrappers, like starred_item ::=  expression | star_expr
  atom                      : /*   ::= unset | identifier | literal | enclosure | builtin__object (Atoms) */ "eyo:atom",
  ...
  identifier                : /*   ::= name | void_name                                   (default) */ "eyo:identifier",
...
eYo.T3.Expr.Check = {
  ...
  non_void_import_identifier_as_list: [ // count 3
    eYo.T3.Expr.name,
    eYo.T3.Expr.void_name,
...
eYo.T3.Expr.Check.identifier = eYo.T3.Expr.Check.dotted_name
eYo.T3.Expr.Check.import_identifier_as = eYo.T3.Expr.Check.non_void_import_identifier_as_list
eYo.T3.Expr.Check.non_void_identifier_list = eYo.T3.Expr.Check.dotted_name
eYo.T3.Expr.Check.with_item = eYo.T3.Expr.Check.with_item_list
eYo.T3.Expr.Check.dotted_name = eYo.T3.Expr.Check.non_void_identifier_list
