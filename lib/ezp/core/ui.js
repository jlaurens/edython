...
EZP.setup.register(function() {
  ...
  EZP.Style.insertCssRuleAt('.ezp-block .blocklyText{\n'+EZP.Font.style+';\n}\n', 0);
  EZP.Style.insertCssRuleAt('.ezp-path-selected{stroke: '+EZP.Style.Path.Selected.colour+';stroke-width: '+EZP.Style.Path.Selected.width+'px;fill: none;}',1);
