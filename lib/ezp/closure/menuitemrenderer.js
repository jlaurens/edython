...
goog.provide('EZP.OptionMenuItemRenderer');
...
EZP.OptionMenuItemRenderer = function() {
  goog.ui.MenuItemRenderer.call(this);
};

goog.inherits(EZP.OptionMenuItemRenderer, goog.ui.MenuItemRenderer);
goog.addSingletonGetter(EZP.OptionMenuItemRenderer);

/**
 * CSS class name the renderer applies to menu item elements.
 * @type {string}
 */
EZP.OptionMenuItemRenderer.CSS_CLASS = goog.getCssName('ezp-menuitem');
...
//  * @private
//  */
// EZP.OptionMenuItemRenderer.prototype.getCompositeCssClass_ = function(index) {
...
// /** @override */
// EZP.OptionMenuItemRenderer.prototype.getAriaRole = function() {
...
//  * @override
//  */
// EZP.OptionMenuItemRenderer.prototype.createDom = function(item) {
...
/** @override */
EZP.OptionMenuItemRenderer.prototype.getContentElement = function(element) {
 ...
 * @override
 */
EZP.OptionMenuItemRenderer.prototype.decorate = function(item, element) {
  goog.asserts.assert(element);
  if (!this.hasContentStructure(element)) {
    element.appendChild(
        this.createContent(element.childNodes, item.getDomHelper()));
  }
  if (goog.dom.classlist.contains(element, goog.getCssName('ezp-option'))) {
...
//  * @override
//  */
// EZP.OptionMenuItemRenderer.prototype.setContent = function(element, content) {
 ...
 * @protected
 */
EZP.OptionMenuItemRenderer.prototype.hasContentStructure = function(element) {
...
//  * @protected
//  */
// EZP.OptionMenuItemRenderer.prototype.createContent = function(content, dom) {
//   var contentClassName = this.getCompositeCssClass_(
//       goog.ui.MenuItemRenderer.CompositeCssClassIndex_.CONTENT);
...
//  */
// EZP.OptionMenuItemRenderer.prototype.setSelectable = function(
...
//  */
// EZP.OptionMenuItemRenderer.prototype.setCheckable = function(
...
//  * @protected
//  */
// EZP.OptionMenuItemRenderer.prototype.hasCheckBoxStructure = function(element) {
//   var contentElement = this.getContentElement(element);
//   if (contentElement) {
...
EZP.setup.register(function() {
  EZP.Style.insertCssRuleAt('.ezp_options .ezp-menuitem-content{padding: 4px 6px 4px '+(EZP.Font.space+12)+'px;}', 6);
});
 ...
 * @protected
 */
EZP.OptionMenuItemRenderer.prototype.setEnableCheckBoxStructure = function(
    item, element, enable) {
  this.setAriaRole(element, item.getPreferredAriaRole());
  this.setAriaStates(item, element);
  var contentElement = this.getContentElement(element);
  if (!item.ezpDomMark) {
    Blockly.utils.addClass(element,'ezp-option');
    var checkboxClassName = this.getCompositeCssClass_(
        goog.ui.MenuItemRenderer.CompositeCssClassIndex_.CHECKBOX);
        var x = 2;
 ...
 * @override
 */
EZP.OptionMenuItemRenderer.prototype.getClassForState = function(state) {
  switch (state) {
    ...
    case goog.ui.Component.State.SELECTED:
      ...
      // compatibility.
      return goog.getCssName('ezp-option-selected');
    default:
 ...
 * @override
 */
EZP.OptionMenuItemRenderer.prototype.getStateFromClass = function(className) {
  var hoverClassName = this.getCompositeCssClass_(
      goog.ui.MenuItemRenderer.CompositeCssClassIndex_.HOVER);
  switch (className) {
    case goog.getCssName('ezp-option-selected'):
...
/** @override */
EZP.OptionMenuItemRenderer.prototype.getCssClass = function() {
  return EZP.OptionMenuItemRenderer.CSS_CLASS;
};
