...
goog.provide('ezP.CodeMenuItemRenderer');
goog.provide('ezP.VarMenuItemRenderer');
...
ezP.CodeMenuItemRenderer = function() {
  ezP.MenuItemRenderer.call(this);
};

goog.inherits(ezP.CodeMenuItemRenderer, ezP.MenuItemRenderer);
goog.addSingletonGetter(ezP.CodeMenuItemRenderer);

ezP.Style.setControlRendererCssClass(
  ezP.CodeMenuItemRenderer,
  'ezp-menuitem-code',
  'content',
  {'': ezP.Font.style},
  'hover',
...
ezP.CodeMenuItemRenderer.prototype.getClassForState
  = ezP.MenuItemRenderer.prototype.getClassForState;
 ...
 * @protected
 */
ezP.CodeMenuItemRenderer.prototype.setEnableCheckBoxStructure = function(
    item, element, enable) {
  ezP.CodeMenuItemRenderer.superClass_.setEnableCheckBoxStructure.call(this,
          item, element, enable);
...
ezP.VarMenuItemRenderer = function() {
  ezP.MenuItemRenderer.call(this);
};

goog.inherits(ezP.VarMenuItemRenderer, ezP.MenuItemRenderer);
goog.addSingletonGetter(ezP.VarMenuItemRenderer);

ezP.Style.setControlRendererCssClass(
  ezP.VarMenuItemRenderer,
  'ezp-menuitem-var',
  'content',
  {'': ezP.Font.style},
  'hover',
...
ezP.VarMenuItemRenderer.prototype.getClassForState
  = ezP.MenuItemRenderer.prototype.getClassForState;
