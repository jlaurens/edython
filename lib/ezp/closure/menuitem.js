...
goog.provide('ezP.CodeMenuItem');
goog.provide('ezP.VarMenuItem');
 ...
 */
ezP.CodeMenuItem = function(content, opt_model, opt_domHelper, opt_renderer) {
  goog.ui.Control.call(
      this, content, opt_renderer || ezP.CodeMenuItemRenderer.getInstance(),
      opt_domHelper);
  this.setValue(opt_model);
};
goog.inherits(ezP.CodeMenuItem, goog.ui.MenuItem);
goog.tagUnsealableClass(ezP.CodeMenuItem);
 ...
 * @extends {goog.ui.MenuItem}
 */
ezP.VarMenuItem = function(content, opt_model, opt_domHelper, opt_renderer) {
  goog.ui.Control.call(
      this, content, opt_renderer || ezP.VarMenuItemRenderer.getInstance(),
      opt_domHelper);
  this.setValue(opt_model);
};
goog.inherits(ezP.VarMenuItem, goog.ui.MenuItem);
goog.tagUnsealableClass(ezP.VarMenuItem);
