...
Blockly.Blocks['ezp_stt'] = {
  init: function() {
    this.appendDummyInput().appendField(new EZP.FieldLabel('statement'));
    this.setInputsInline(true);
    this.setPreviousStatement(true, EZP.C10nType.stt.before_any);
    this.setNextStatement(true, EZP.C10nType.stt.after_any);
    this.setTooltip('');
    this.setHelpUrl('');
  }
};
...
Blockly.Blocks[EZP.Constants.grp.ANY] = {
  init: function() {
    this.appendDummyInput().appendField(new EZP.FieldTextInput(''), 'STT');
    this.appendStatementInput('DO').setCheck(EZP.C10nType.stt.after_any);
    this.setInputsInline(true);
    this.setPreviousStatement(true, EZP.C10nType.stt.before_any);
    this.setNextStatement(true, EZP.C10nType.stt.after_any);
    this.setTooltip('');
...
Blockly.Blocks[EZP.Constants.grp.IF] = {
  init: function() {
    ...
    this.appendStatementInput('DO').setCheck(EZP.C10nType.stt.after_any);
    this.setInputsInline(true);
    this.setPreviousStatement(true, EZP.C10nType.stt.before_if);
    this.setNextStatement(true, EZP.C10nType.stt.after_if);
    this.setTooltip('');
    this.setHelpUrl('');
  }
};
Blockly.Blocks[EZP.Constants.grp.ELIF] = {
  init: function() {
    ...
    this.appendStatementInput('DO').setCheck(EZP.C10nType.stt.after_any);
    this.setInputsInline(true);
    this.setPreviousStatement(true, EZP.C10nType.stt.before_elif);
    this.setNextStatement(true, EZP.C10nType.stt.after_elif);
    this.setTooltip('');
    this.setHelpUrl('');
  }
};
Blockly.Blocks[EZP.Constants.grp.ELSE] = {
  init: function() {
    ...
    this.appendStatementInput("DO").setCheck(EZP.C10nType.stt.after_any);
    this.setInputsInline(true);
    this.setPreviousStatement(true, EZP.C10nType.stt.before_else);
    this.setNextStatement(true, EZP.C10nType.stt.after_else);
    this.setTooltip("");
    this.setHelpUrl("");
  }
};
Blockly.Blocks[EZP.Constants.grp.WHILE] = {
  init: function() {
    this.appendValueInput('TEST').setCheck(EZP.C10nType.val.require_any).appendField(new EZP.FieldLabel('while'));
    this.appendDummyInput().appendField(new EZP.FieldLabel(':'));
    this.appendStatementInput('DO').setCheck(EZP.C10nType.stt.after_any);
    this.setInputsInline(true);
    this.setPreviousStatement(true, EZP.C10nType.stt.before_loop);
    this.setNextStatement(true, EZP.C10nType.stt.after_loop);
    this.setTooltip('');
    this.setHelpUrl('');
  }
};
Blockly.Blocks[EZP.Constants.grp.FOR] = {
  init: function() {
    this.appendValueInput('VAR').setCheck(EZP.C10nType.val.require_any).appendField(new EZP.FieldLabel('for'));
    this.appendValueInput('SET').setCheck(EZP.C10nType.val.require_any).appendField(new EZP.FieldLabel('in'));
    this.appendDummyInput().appendField(new EZP.FieldLabel(':'));
    this.appendStatementInput('DO').setCheck(EZP.C10nType.stt.after_any);
    this.setInputsInline(true);
    this.setPreviousStatement(true, EZP.C10nType.stt.before_loop);
...
Blockly.Blocks[EZP.Constants.val.GET] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new EZP.FieldVariable('item'), 'NAME');
    this.setInputsInline(true);
    this.setOutput(true, null);
    this.setTooltip("");
    this.setHelpUrl("");
