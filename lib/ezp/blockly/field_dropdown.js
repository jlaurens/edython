 ...
 * @constructor
 */
ezP.FieldDropdownCode = function(menuGenerator, opt_validator) {
  ezP.FieldDropdown.superClass_.constructor.call(this, menuGenerator, opt_validator);
};
...
ezP.FieldDropdown.prototype.render_ = function() {
  ...
  this.size_.width += ezP.Style.MenuIconWidth;
};

ezP.FieldDropdownCode.prototype.getSerializedXml = function() {
  var container = Blockly.FieldVariable.superClass_.getSerializedXml.call(this);
  container.setAttribute('code', this.getValue());
  return container;
}

ezP.FieldDropdownCode.prototype.deserializeXml = function(xml) {
  this.setValue(xml.getAttribute('code') || '');
}
