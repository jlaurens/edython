...
ezP.PrintFieldDropdown.CSS_MENU_CLASS = 'ezp-print-block-menu';
ezP.Style.insertCssRuleAt('.'+ezP.PrintFieldDropdown.CSS_MENU_CLASS+'{\n'+ezP.Font.style+';\n}\n');
...
ezP.PrintFieldDropdown.prototype.createMenu_ = function() {
  var renderer = goog.ui.ContainerRenderer.getCustomRenderer(
      goog.ui.MenuRenderer, ezP.PrintFieldDropdown.CSS_MENU_CLASS);
 ...
 * @return yorn
 */
ezP.PrintFieldDropdown.prototype.isInputVisible = function(input) {
  switch(input.name) {
    case ezP.PrintFieldDropdown.END:
    case ezP.PrintFieldDropdown.SEP:
    case ezP.PrintFieldDropdown.FILE:
      return this.ezpState[input.name] == true;
    default:
      return undefined;
  }
};
 ...
 */
ezP.PrintFieldDropdown.prototype.addSelect = function() {
 ...
 */
ezP.PrintFieldDropdown.prototype.removeSelect = function() {
  if (this.imageElement_) {
