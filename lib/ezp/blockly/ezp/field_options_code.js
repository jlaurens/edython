...
ezP.FieldOptionsCode = function(menuGenerator, opt_validator) {
  ezP.FieldOptionsCode.superClass_.constructor.call(this, menuGenerator, opt_validator);
...
ezP.FieldOptionsCode.prototype.init = function() {
  ...
  this.arrow_ = ezP.Style.MenuIcon(this.fieldGroup_);
};
