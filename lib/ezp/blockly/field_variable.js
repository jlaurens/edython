...
ezP.FieldVariable = function(varname, opt_validator, opt_variableTypes) {
  ezP.FieldVariable.superClass_.constructor.call(this, null, opt_validator);
  this.variableTypes = opt_variableTypes;
};
goog.inherits(ezP.FieldVariable, Blockly.Field);
...
ezP.FieldVariable.prototype.init = function() {
  ...
  this.mouseDownWrapper_ =
      Blockly.bindEventWithChecks_(this.imageElement_, 'mousedown', this,
      this.onMouseDown_);
...
ezP.FieldVariable.prototype.setValue = function(value) {
  if (!value || this.ezp_varId_ == value) {
    return;
  }
...
ezP.FieldVariable.prototype.showEditor_ = function() {
  ...
  menu.showMenu(this.imageElement_,bbox.left-12+1+4,bbox.bottom+4);
};
